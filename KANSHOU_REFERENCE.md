...
## 🎊 節慶橋段：不限時段·不限地點（2026-07 玩家定案）

節慶一年就那麼一天，卡時段等於大半天感受不到過節氣氛。地點**本來就沒限制**（節慶事件不綁 location，只要當天有同伴在場就注入），這次把 `bands` 閘門也拿掉——`KANSHOU_FESTIVAL_EVENTS_` 的 `bands` 欄位保留但**不再被讀取**（留著當文件，日後想恢復時段限定不必重寫結構）。

改法遵循「不提就不用禁」：不是加條件去擋，而是**把 ambient 文字改寫成任何時刻都成立的說法**——
- 初詣：~~新年初一，她正準備去神社初詣參拜~~ → 新年頭一天，街上到處是要去神社參拜的人潮與攤販
- 中秋：~~中秋夜月色正好，她正抬頭望著那輪滿月~~ → 中秋，空氣裡都是月餅與團圓的味道，今晚的月亮會特別圓
- 跨年：~~跨年夜，遠處已經有人開始倒數~~ → 一年的最後一天，街上到處是準備跨年的人與收攤的年貨
