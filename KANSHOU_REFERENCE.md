...
1. **「女子體態柔美(柔嫩/雪白/婉約·出力柔中帶勁)」→ 收窄**（玩家原話：「這體態可以不要 我主要是不要讓AI
   敘述女性時候有甚麼薄繭…然後出力也不能用甚麼鋼鐵夾住這種奇怪的形容才會增加這一句的」）。
   ⚠ **它是對的補丁、只是包太寬**：這些角色在原作是戰士，模型會自然寫出薄繭/傷疤/鋼鐵般的力道，所以要擋；
   但「雪白」把膚色定死、「婉約」把氣質定死——那兩件事該由各人自己的 `[外貌氣質]` 決定。
   新版：`女子的身體一律柔軟溫熱、手細嫩無繭無疤·力道用絞緊/包裹/吸附這類柔性的寫法，不用鋼鐵/鉗子/機械。`
...
**系統提示詞 2379 → 1899 字。**
⚠️ **CLAUDE.md 的紅線① 需要玩家決定怎麼改**：現行條文寫「一律不可改」＋「事後 `git diff | grep
nsfwBaseRules` 須 0 改動」。這次之後那條驗證方式已經不成立，但**保護的意圖仍然有效**——
建議改成「不得未經玩家逐項授權而改動」，而不是刪掉。**我不擅自改玩家的錨點檔。**
