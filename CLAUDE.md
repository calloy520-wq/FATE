...
🔵 **2026-07 玩家推翻部分經濟決定，僅 kanshou 恢復真經濟層**（2026-07-13「真的要賺錢 然後要付住宿費用?每個禮拜要付錢?我要去打工賺錢?!」，確認要「真的有系統記錄、會被扣款/賺取」、範圍「僅鑑賞」）：Phase 1（已實作，見 SOLO_REFERENCE.md §76）——`COL.PC.MONEY`/`RENT_WEEK`（尾端新欄，solo 恆空）、開局起始金錢 3000、💼打工固定薪資 800/次(耗時4h)、每週房租 1500(可透支成負值，無懲罰機制，純軟性)。Phase 2（已實作，見 SOLO_REFERENCE.md §77）——🛍️商店：資料驅動品項表(`KANSHOU_SHOP_ITEMS_`)，裝飾品買了存玩家 MEMORY【家居裝飾】清單(narration可參考)，禮物買了直接送同行夥伴、好感依固定值增加(GAS掌數值)。**這條路線僅限 kanshou，solo 依然全程無花錢入口不變**。Phase 3 起(家事整潔度/任務系統)尚未實作，之後陸續加。
