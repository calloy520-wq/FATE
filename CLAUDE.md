...
- **單人 solo（主體）**：只有「按鍵 ＋ AI 敘述」。可多帳號遊玩，但**資料必須分流不污染**（game_id 實例化 ＋ 帳號綁定，務必守住）。盡可能貼近 Fate 原作（動畫/遊戲/電影合理還原）。
- **多人**：不做完整模擬，已以**排行榜**呈現（登入選單 🏆，`actionLeaderboard`）。只撈持久層(帳號表勝場/最快奪杯日/建立時間＋鑑賞圖鑑數)，眾生/關係會被清檔刪、不可依賴。
- **鑑賞 kanshou**：專注在**九州慾海模式**（奪杯後的約會/後日談）。方向是**盡量保留九州現有資料與系統**，未來可能讓它「打工賺錢→買禮物」這類玩法。
  - ⚠ **錢的雙面性**：solo 全程無花錢入口（錢是死欄，身世財力差異改由起始禮裝體現）；**但九州的 money/聽風閣/商城/給銀兩系統要保留給 kanshou/full**——別為了「solo 用不到」就砍掉九州經濟系統。
