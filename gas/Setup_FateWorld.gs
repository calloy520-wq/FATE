...
var FATE_SHEET_DEFS = {
  ...
  // 🆕 尾端新增「日常外貌／日常性格」(2026-07)：鑑賞用都市日常版，懶惰快取(見 COL.HERO 註解/heroToKanshouRow_)。
  "英靈殿": ["英靈ID","職階","真名","性別","六圍","職階技能","固有技能","特性","寶具","人格","陣營","出沒戰爭","來源","日常外貌","日常性格"],
  "御主殿": ["御主ID","姓名","性別","外貌","魔術系統","魔術迴路","體術","魔術階位","居所","願望","人格","戰爭","來源","身世","萌點"],
  "帳號": ["帳號名","角色ID","建立時間","鑑賞角色ID"],
  "鑑賞": ["帳號名","真名","職階","性別","六圍","標籤","寶具","生平","個性","萌點","羈絆回憶","願望結局","解鎖時間","御主名","御主性別","外貌肉體"],
  "歷史暫存": ["時間", "角色ID", "發話者", "內容"]
};
