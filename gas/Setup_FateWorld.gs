...
var FATE_SHEET_DEFS = {
  ...
  "眾生":   ["角色ID","姓名","性別","身世","外顯狀態","財帛","特徵","所在","喜好","氣血","真元","力","體","敏","慧","運","氣血上限","真元上限","武器","防具","飾物一","飾物二","境界","記憶","意圖","勢力","位階","貢獻","陣營","體徵","武學","生活技能","局號","職階","六圍","標籤"],
...
var FATE_MAP_SEED = [
  ["冬木", "冬木·新都",   "城區", "2,3",   "跨越未遠川西岸的現代都心，高樓林立、人潮喧囂，霓虹徹夜未熄。", "冬木"],
  ["冬木", "冬木·深山町", "城區", "-3,2",  "未遠川東岸的老住宅區，坡道與舊宅交錯，衛宮宅坐落於此。", "冬木"],
  ["冬木", "冬木大橋",     "城區", "0,2",   "橫跨未遠川、連接新都與深山町的大橋，夜裡風聲如刃。", "冬木"],
  ["冬木", "冬木·商店街", "城區", "1,2",   "新都的繁華商街，適合補給與探聽風聲。", "冬木"],
  ["冬木", "穗群原學園",   "城區", "-4,3",  "深山町的高中，白日學子往來，入夜後空曠寂寥。", "冬木"],
  ["冬木", "未遠川河畔",   "靈地", "0,1",   "分隔冬木東西的大河，水氣氤氳，靈脈隱隱流動。", "冬木"],
  ["冬木", "柳洞寺",       "靈地", "5,6",   "未遠川源頭山上的古剎，靈脈匯聚，是絕佳據點，亦是兵家必爭之地。", "冬木"],
  ["冬木", "言峰教會",     "祭壇", "1,5",   "山丘上的天主教堂，聖杯戰爭的監督者於此坐鎮，提供中立庇護。", "冬木"],
  ["冬木", "遠坂宅",       "據點", "3,1",   "新都一隅的西式洋館，遠坂家宅邸，結界森嚴。", "冬木"],
  ["冬木", "間桐宅",       "據點", "-2,-1", "深山町外緣的陰森洋宅，地底蟲窟蔓延，令人作嘔。", "冬木"]
];
