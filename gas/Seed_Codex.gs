...
var SEED_MASTERS = [
  ...
  {id:'肯尼斯-4th',    name:'肯尼斯', gender:'男', appearance:'金髮高傲的年輕教授',     war:'4th', magic:'礦石科・流體操作',      circuits:65, melee:'C', magic_rank:'A', home:'海特飯店', wish:'榮譽與學術成就',          persona:'高傲的天才教授・極高的自尊・喜歡學術與名譽・厭惡被輕視', back:'時鐘塔礦石科年輕天才講師，攜未婚妻索菈參戰，自視甚高、絕不容許在這場戰爭裡蒙受任何屈辱', moe:'天才的傲慢與脆弱自尊、對未婚妻意外的深情、被打臉時的崩潰、學究的一板一眼'},
  // ⚠ 2026-07 修：home補「麥肯基宅」(他借住深山町山丘上的老夫婦家，非新都鬧區)；circuits25→15(原作明寫他是時鐘塔墊底的資質，跟肯尼斯拉開懸殊差距)。
  {id:'韋伯·維爾維特-4th',name:'韋伯·維爾維特', gender:'男', appearance:'黑髮瘦小的少年魔術師',war:'4th',magic:'自我暗示・基礎魔術', circuits:15, melee:'E', magic_rank:'C', home:'麥肯基宅', wish:'證明自己的價值',          persona:'故作老成的少年・自卑卻好強・喜歡證明自己・厭惡被當作無能', back:'出身平凡的時鐘塔末席學生，為證明「才能非血統決定」偷走觸媒召喚出與自己羈絆深厚的英靈，一路成長', moe:'嘴硬的自卑少年、被並肩的從者一路磨礪帶著成長、口嫌體正直、偷偷崇拜那位豪邁的英靈'},
  // ⚠ 2026-07 修：wish原「召喚惡魔」是誤植——他對聖杯毫無興趣，真正圖的是跟從者一起體驗新奇殺戮的快感；home補實際據點(澪標川下水道廢棄工房，非新都鬧區)。
  {id:'雨生龍之介-4th',name:'雨生龍之介', gender:'男', appearance:'輕浮的金髮青年，咧嘴而笑', war:'4th', magic:'無魔術・召喚術（外行）', circuits:10, melee:'C', magic_rank:'E', home:'碼頭倉庫', wish:'見識更新奇的殺戮・與從者共享獵奇的快感',persona:'輕浮開朗的青年・天生純粹之惡・喜歡有趣與新鮮的死亡・厭惡無聊', back:'毫無魔術素養卻天生純粹的殺人狂，誤打誤撞召喚出與自己瘋狂共鳴的英靈，把殺戮當成有趣的遊戲', moe:'開朗笑容下的純粹瘋狂、對「有趣」孩子般的好奇、與其從者的瘋狂默契、毫無惡意的惡'},
...
var CODEX_PERSONA_VER = 'v45'; // v45：肯尼斯/韋伯/雨生龍之介的 home 改成直接對應新增地圖節點名稱(海特飯店/麥肯基宅/碼頭倉庫)，
