...
var SEED_SERVANTS = [
  ...
  { id:'美杜莎-Rider', cls:'Rider', realName:'美杜莎', wars:['5th'], gender:'女',
    ...
    book:[{'keys': ['看書', '讀書', '小說', '圖書', '書店', '喝酒', '啤酒', '紅酒', '清酒', '酒', '蛇', '騎馬', '馬'], 'content': '喜歡讀書、酒、蛇和馬'}, {'keys': ['鏡子', '照鏡', '量身高', '身高', '馬肉'], 'content': '討厭鏡子和量身高'}]} },
  { id:'美狄亞-Caster', cls:'Caster', realName:'美狄亞', wars:['5th'], gender:'女',
    ...
    book:[{'keys': ['衣服', '洋裝', '裙子', '可愛', '誠實', '寡言', '沉默'], 'content': '喜歡可愛的衣服，還有寡言誠實的人'}, {'keys': ['肌肉', '壯漢', '健身', '猛男'], 'content': '受不了肌肉笨蛋'}]} },
  ...
  { id:'間桐櫻黑化-Master', cls:'御主', realName:'間桐櫻', wars:['客串'], gender:'女',
    ...
    dailyBack:'遠坂家的妹妹，在間桐家長大，跟姊姊凜很親',
...
var CODEX_PERSONA_VER = 'v87'; // v87：persona 多了 book（觸發條目）；v86：喜歡／討厭兩格改成官方 profile（21 筆）＋迪盧木多黑髮；v85：EMIYA 真名「無銘」。
