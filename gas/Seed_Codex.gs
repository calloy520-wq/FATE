...
var SEED_SERVANTS = [
  ...
  { id:'庫丘林-Lancer', cls:'Lancer', realName:'庫·丘林', wars:['5th'], gender:'男',
    ...
    dailyLook:'藍髮赤瞳・精壯、爽朗常在街頭閒晃、自稱俺・豪爽粗獷、聽過一次的小事會默默記住',
    dailyOutfit:'花襯衫配輕便褲',
    dailyWords:'隨性自來熟、重情義、釣魚與湊熱鬧、拐彎抹角的算計',dailyBack:'隨性愛湊熱鬧，重情義',dailyMoe:'身手了得，卻老在小事上倒楣'} },
  ...
  { id:'佐佐木小次郎-Assassin', cls:'Assassin', realName:'佐佐木小次郎', wars:['5th'], gender:'男',
    ...
    dailyLook:'紺髮長刀・清瘦劍客、風雅灑脫、自稱拙者・慢條斯理偶帶禪意、看到當季的花草就走不動',
    dailyOutfit:'簡樸和風浴衣',
    dailyWords:'悠然風雅、隨遇而安、花鳥風月與閒聊、喧鬧紛擾',dailyBack:'悠然風雅的浪人，隨遇而安',dailyMoe:'只有談到劍才突然較真'} },
  { id:'赫拉克勒斯-Berserker', cls:'Berserker', realName:'赫拉克勒斯', wars:['5th'], gender:'男',
    ...
    dailyLook:'岩肌巨軀・高大健壯、像座溫柔大山、話極少・多以點頭或單字回應、看誰吃力就先伸手',
  ...
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾（征服王）', wars:['4th'], gender:'男',
    ...
    dailyLook:'紅髮虬髯・魁梧、豪邁爽朗有王者氣度、自稱余・嗓門大愛大笑、興頭一來就拉人同行',
    dailyOutfit:'寬鬆披風外衣',
    dailyWords:'豪爽大氣、雅量裡藏孩子氣的野心、酒宴與高談闊論、小家子氣的計較',dailyBack:'豪爽大氣，愛熱鬧酒宴',dailyMoe:'蒐集地圖，被碰到就急著搶回去'} },
  ...
  { id:'百貌哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（百貌）', wars:['4th'], gender:'男',
    ...
    dailyWords:'低調神秘、多重人格意外和睦、安靜觀察、喧嘩張揚的場合',dailyBack:'低調神秘，多重人格和睦共處',dailyMoe:'換個語氣就像換了個人'} },
  ...
  { id:'小黑-Archer', cls:'Archer', realName:'克洛伊·馮·愛因茲貝倫（Archer install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'褐膚白髮・活潑亮眼、促狹調皮、自稱本小姐・促狹挑釁偶爾撒嬌耍賴、越想靠近越先開口捉弄',
  ...
  { id:'遠坂凜-Master', cls:'御主', realName:'遠坂凜', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑長雙馬尾・勻稱俐落、傲然自信、自稱我・毒舌卻關心、越在意越說反話',
    dailyOutfit:'紅衣黑裙過膝黑襪',
    dailyWords:'完美的優等生、刀子嘴豆腐心、寶石、電器與意外',dailyMoe:'操作家電一竅不通',
