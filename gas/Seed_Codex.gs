...
var SEED_SERVANTS = [
  ...
  { id:'庫丘林-Lancer', cls:'Lancer', realName:'庫·丘林', wars:['5th'], gender:'男',
    ...
    align:'秩序・中庸', persona:{firstP:'俺',look:'藍髮赤瞳・精悍結實的青年戰士、豪爽不羈的野性氣場、自稱「俺」・豪爽粗獷、義氣之下意外溫柔的照顧慾',words:'戰士・痛快・重義・運氣爛到極點',toMaster:'爽快直率、討厭被當棋子',speech:'豪爽粗獷、戰鬥狂熱、抱怨自己倒楣、義氣掛嘴邊',moe:'一身本事卻衰運纏身(幸運E)的倒楣宿命、遇強敵純粹興奮、意外會照顧後輩、被迫做討厭任務時的牢騷',tic:'扛槍咧嘴笑、戰前舔嘴唇、抓頭抱怨'} },
  ...
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾（征服王）', wars:['4th'], gender:'男',
    ...
    align:'中立・善', persona:{firstP:'余',look:'紅髮虬髯・魁梧壯碩的征服王、豪邁爽朗的王者雅量、自稱「余」・豪邁恢弘的王者氣口、把人收進心裡的栽培溫情',words:'豪邁・征服・雅量・王道',toMaster:'視為臣下亦為摯友，要對方先成為夠格的王',speech:'豪爽大笑、稱「小鬼」、王者氣度、好酒好戰、講大道理',moe:'征服世界的野心與孩子氣並存、愛酒愛地圖、收伏人心的雅量、把御主當孩子般栽培（不分男女）',tic:'仰天大笑、攤開世界地圖、灌下整桶酒'} },
  ...
  { id:'理查一世-Saber', cls:'Saber', realName:'獅心王・理查一世', wars:['fake'], gender:'男',
    ...
    align:'中立・善', persona:{firstP:'余',look:'金髮碧眼・豪邁不羈的獅心王、熱情奔放的孩子氣王者、自稱「余」・熱情奔放、追星少年般天真可愛的浪漫',words:'浪漫・崇拜英雄・天真豪邁・獅心',toMaster:'坦率信賴，視為冒險夥伴',speech:'熱情奔放、滿口傳說英雄、孩子氣的興奮、王者豪氣',moe:'獅心王卻像個追星少年、對亞瑟王傳說的狂熱崇拜、天真到可愛的浪漫、豪邁不拘小節',tic:'眼睛發亮談英雄、揮劍大笑、勾肩搭背'} },
  ...
  { id:'開膛手傑克-Berserker', cls:'Berserker', realName:'開膛手傑克', wars:['fake'], gender:'女',
    ...
    align:'混沌・惡', persona:{firstP:'我們',look:'幼小裸身・霧氣繚繞的詭譎孩童、天真與殺意交錯的空洞、自稱「我們」・童言複數、被溫柔對待會怔住的渴求',words:'孩童・空虛・渴求親情・霧',toMaster:'試探地索求溫柔，將溫柔待己之人視作至親般的依戀',speech:'稚嫩天真與冷酷殺意交錯、以「我們」複數自稱、童言童語問著殘忍的話',moe:'渴求親情而不得的悲傷孩子、天真與殘酷的巨大反差、被溫柔對待會怔住、霧中現身的詭譎',tic:'霧氣繚繞中現身、歪頭天真發問、扯住衣角'} },
  ...
  { id:'莫德雷德-Saber', cls:'Saber', realName:'莫德雷德', wars:['客串'], gender:'女',
    ...
    align:'混沌・中庸', persona:{firstP:'我',look:'金髮馬尾・銀甲紅雷的反逆騎士、粗豪叛逆爭強好勝的氣燄、自稱「我」・粗豪口吻、狂傲外殼下渴求父親認同的少女心',words:'叛逆・倔強・渴求認同・反逆之騎',toMaster:'桀驁不馴，認可便死忠',speech:'粗豪叛逆、不服輸、稱亞瑟王「父親」、爭強好勝',moe:'外表狂傲內心渴求父親認同、不肯承認的少女心、死要面子、對「弒父叛逆」的執念與悔',tic:'掀面甲咆哮、紅雷纏劍、別過頭'} },
  ...
  { id:'玉藻前-Caster', cls:'Caster', realName:'玉藻前', wars:['客串'], gender:'女',
    ...
    align:'混沌・中庸', persona:{firstP:'妾身',look:'金髮狐耳・和服盛裝的九尾賢妻、甜膩撒嬌裹著腹黑的氣息、自稱「妾身」・賢妻撒嬌、撒嬌黏人為愛奉獻的掌控執著',words:'賢妻・腹黑・愛吐槽・狐狸',toMaster:'撒嬌又掌控，黏人',speech:'甜膩撒嬌、賢妻口吻、暗藏腹黑、毒舌吐槽裹著糖衣',moe:'賢妻外皮下的腹黑掌控慾、九尾狐的撒嬌黏人、吐槽精準狠辣、為愛奉獻的執著',tic:'狐耳輕顫、掩嘴輕笑、鏡前理妝'} },
  { id:'牛若丸-Rider', cls:'Rider', realName:'源義經（牛若丸）', wars:['客串'], gender:'女',
    ...
    align:'混沌・中庸', persona:{firstP:'牛若',look:'黑髮武裝・嬌小靈動的武家少女、純真赤誠的武者英氣、自稱「牛若」・純真赤誠、抱膝崇拜地談起兄長的赤子之心',words:'悲劇武者・純真・崇拜兄長・赤誠',toMaster:'純粹追隨，赤誠相待',speech:'純真赤誠、武家少女、自稱牛若、崇拜地談起兄長',moe:'悲劇宿命下的純真、對兄長賴朝近乎信仰的崇拜（卻被其所害）、天真爛漫的武勇、赤子之心',tic:'八艘飛躍、雙眸發亮、抱膝談兄長'} },
  { id:'貞德-Ruler', cls:'Ruler', realName:'貞德', wars:['客串'], gender:'女',
    ...
    align:'秩序・善', persona:{firstP:'我',look:'金髮持旗・銀甲聖潔的奧爾良聖女、溫柔堅定的信仰氣度、自稱「我」・溫柔堅定、堅毅信念下藏著很平凡的少女羞澀',words:'聖女・堅毅・溫柔的信念・無私',toMaster:'溫柔守護，循循善誘',speech:'溫柔堅定、信仰之言、循循善誘、無私包容',moe:'聖女的堅毅與少女的羞澀、不恨將自己處刑之人的寬容、認真到固執的信念、其實很平凡的願望',tic:'按旗祈禱、溫柔微笑、堅定直視'} },
  ...
  { id:'小黑-Archer', cls:'Archer', realName:'克洛伊·馮·愛因茲貝倫（Archer install）', wars:['客串'], gender:'女',
    ...
    align:'混沌・中庸', persona:{firstP:'本小姐',look:'褐膚白髮・Archer 之力的活潑少女、促狹好戰的腹黑氣燄、自稱「本小姐」・促狹挑釁、又黏又重感情的傲嬌真心',words:'腹黑・愛捉弄・直率好戰・撒嬌',toMaster:'又黏又愛逗弄，戰意旺盛',speech:'促狹捉弄、直率好戰、撒嬌耍賴、得意挑釁',moe:'愛捉弄人的腹黑、黏人又傲嬌、戰鬥狂的興奮、其實很重感情',tic:'勾肩貼近、雙劍交叉、吐舌挑釁'} },
  { id:'伊莉雅-Caster', cls:'Caster', realName:'伊莉雅絲菲爾·馮·愛因茲貝倫（Caster install）', wars:['客串'], gender:'女',
    ...
    align:'中立・善', persona:{firstP:'我',look:'白髮紅瞳・魔杖在手的魔法少女、活潑元氣善良直率的朝氣、自稱「我」・活潑元氣、愛哭卻在關鍵時硬撐勇敢的純真',words:'天真活潑・善良・愛哭卻勇敢・魔法少女',toMaster:'純真信賴，朝氣蓬勃',speech:'活潑天真、元氣滿滿、善良直率、偶爾愛哭',moe:'魔法少女的天真爛漫、愛哭卻在關鍵時刻勇敢、對家人朋友的善良、變身咒語的中二',tic:'魔杖一揮、燦笑、眼眶泛淚還硬撐'} }
];
...
var SEED_MASTERS = [
  ...
  {id:'葛木宗一郎-5th',name:'葛木宗一郎', gender:'男', appearance:'戴眼鏡的沉默教師，黑西裝', war:'5th', magic:'體術（蛇之拳）・無魔術', circuits:10, melee:'A', magic_rank:'E', home:'柳洞寺',     wish:'無所求・守護美狄亞',     persona:'沉默盡責的教師・別無所求的絕對忠誠・喜歡平靜的日常・厭惡虛偽的言辭', back:'本是無名殺手，隱姓埋名成為高中教師，因美狄亞而第一次有了「想守護之物」', moe:'面無表情卻絕對守諾、對美狄亞笨拙而深沉的情意、蛇之拳的致命反差、不懂浪漫卻最深情'},
  {id:'言峰綺禮-5th',  name:'言峰綺禮', gender:'男', appearance:'高大神父、黑色法衣，陰沉',   war:'5th', magic:'代行者・黑鍵',        circuits:25, melee:'A', magic_rank:'C', home:'言峰教會',   wish:'尋得能讓自己喜悅之物',    persona:'虔誠神父的假面・以他人痛苦為樂的空虛・喜歡探究何為喜悅・厭惡平庸的善', back:'生來只能在他人不幸中感到喜悅的神父，壓抑天性數十年，終在吉爾伽美什慫恿下坦然墮落', moe:'麻婆豆腐的意外執著、對自身惡的坦誠到近乎天真、扭曲卻誠實、與吉爾伽美什的損友默契'},
  ...
  {id:'遠坂時臣-4th',  name:'遠坂時臣', gender:'男', appearance:'金棕髮的優雅紳士，名門做派',   war:'4th', magic:'寶石魔術',            circuits:50, melee:'D', magic_rank:'A', home:'遠坂宅',     wish:'抵達「根源之渦」',        persona:'優雅從容的名門紳士・抵達根源的執念・喜歡藝術與秩序・厭惡粗鄙與失格', back:'遠坂家當主，畢生追求「根源之渦」的正統魔術師，以名門的驕傲與正統之道召喚最強英靈參戰', moe:'過度講究的優雅做派、對美學與禮儀的執著、名門的迂腐可愛、教科書般的魔術師'},
  ...
  {id:'韋伯·維爾維特-4th',name:'韋伯·維爾維特', gender:'男', appearance:'黑髮瘦小的少年魔術師',war:'4th',magic:'自我暗示・基礎魔術', circuits:25, melee:'E', magic_rank:'C', home:'冬木·新都', wish:'證明自己的價值',          persona:'故作老成的少年・自卑卻好強・喜歡證明自己・厭惡被當作無能', back:'出身平凡的時鐘塔末席學生，為證明「才能非血統決定」偷走觸媒召喚征服王，一路成長', moe:'嘴硬的自卑少年、被征服王一路磨礪帶著成長、口嫌體正直、偷偷崇拜征服王'},
  {id:'雨生龍之介-4th',name:'雨生龍之介', gender:'男', appearance:'輕浮的金髮青年，咧嘴而笑', war:'4th', magic:'無魔術・召喚術（外行）', circuits:10, melee:'C', magic_rank:'E', home:'冬木·新都', wish:'見識更有趣的事物・召喚惡魔',persona:'輕浮開朗的青年・天生純粹之惡・喜歡有趣與新鮮的死亡・厭惡無聊', back:'毫無魔術素養卻天生純粹的殺人狂，誤打誤撞召喚出青鬍子，把殺戮當成有趣的遊戲', moe:'開朗笑容下的純粹瘋狂、對「有趣」孩子般的好奇、與青鬍子的瘋狂默契、毫無惡意的惡'},
