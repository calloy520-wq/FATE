...
var SEED_SERVANTS = [
  ...
  { id:'美杜莎-Rider', cls:'Rider', realName:'美杜莎', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫長髮・高挑豐滿、身形矯健的女子身影、氣質溫婉恬靜、自稱「我」・寡言低沉但語氣裡藏著溫柔、私下看到別人小小的善意會偷偷紅了眼眶，卻總是很快若無其事地眨眼帶過',
  ...
  { id:'斯卡哈-Lancer', cls:'Lancer', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・身形豐滿妖嬈、妖豔冷峻的女子身影、氣質居高臨下卻自持有度、自稱「我」・偶爾露出揶揄語氣，帶著嚴師的威嚴、被人由衷稱讚時會有一瞬間的怔住，隨即若無其事地別開臉',
  ...
  { id:'斯卡哈-Assassin', cls:'Assassin', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・身形豐滿、冷冽優雅的女子身影、氣質慵懶自在中帶著一絲警覺、自稱「我」・說話低冷簡短・一針見血、私下其實很享受被人依賴的感覺，即使嘴上總是一副事不關己的樣子',
