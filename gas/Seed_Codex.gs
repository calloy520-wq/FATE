...
var SEED_SERVANTS = [
  ...
  { id:'阿爾托莉雅-Saber', cls:'Saber', realName:'阿爾托莉雅·潘德拉貢', wars:['4th','5th'], gender:'女',
    ...
    dailyLook:'金髮碧眼・嬌小的少女身影、端莊凜然中帶著鄰家女孩的親和感、自稱「我」・說話依然簡潔認真但偶爾透出少女心的靦腆、私下藏著對美食的驚人食量與被稱讚廚藝時的雀躍',
  ...
  { id:'EMIYA-Archer', cls:'Archer', realName:'無名（EMIYA）', wars:['5th'], gender:'男',
    ...
    dailyLook:'褐膚白髮・面容冷峻的青年、給人可靠又愛操心的兄長感、自稱「我」・嘴上嫌麻煩卻藏不住認真叮嚀的語氣、私下總在不知不覺間把身邊人的麻煩事處理妥當',
  ...
  { id:'美杜莎-Rider', cls:'Rider', realName:'美杜莎', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫長髮・高挑矯健的女子身影、氣質溫婉恬靜、自稱「我」・寡言低沉但語氣裡藏著溫柔、私下家事身手意外地好，也很享受安靜做家事的時光',
  ...
  { id:'美狄亞-Caster', cls:'Caster', realName:'美狄亞', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫色長髮・清麗的女子身影、散發優雅疏離的氣息、自稱「我」・溫婉敬語中藏著一絲小心翼翼、私下被真心對待時會意外慌張，藏不住的小小驚喜',
    dailyOutfit:'溫柔色系的洋裝',
  ...
  { id:'佐佐木小次郎-Assassin', cls:'Assassin', realName:'佐佐木小次郎', wars:['5th'], gender:'男',
    ...
    dailyLook:'紺髮長刀・清瘦的劍客身影、氣質風雅灑脫、自稱「拙者」・慢條斯理偶帶禪意、私下偶爾也會對路過的閒聊認真起來，露出較真的一面',
    dailyOutfit:'簡樸和風浴衣',
  ...
  { id:'迪盧木多-Lancer', cls:'Lancer', realName:'迪盧木多·奧迪那', wars:['4th'], gender:'男',
    ...
    dailyLook:'墨綠髮・俊美的騎士身影(面上淡淡的愛之痣)、氣質謙恭有禮、自稱「我」・說話依然謙恭有禮，總是壓抑著情感、私下其實很享受堂堂正正切磋較量的暢快，卻渾然不覺自己有多受歡迎',
    dailyOutfit:'整潔的紳士便裝',
  ...
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾（征服王）', wars:['4th'], gender:'男',
    ...
    dailyLook:'紅髮虬髯・魁梧的男子身影、豪邁爽朗中帶著王者的氣度、自稱「余」・豪爽大笑，愛稱人一聲「小鬼」、私下聊起遠方見聞會像孩子一樣眼睛發亮',
  ...
  { id:'咒腕之哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（咒腕）', wars:['5th'], gender:'男',
    ...
    dailyLook:'戴著骷髏面具・右臂纏著繃帶的沉靜身影、氣質肅穆而低調、自稱「我」・話極少，必要時才低沉簡短地開口、私下其實把答應過的每件小事都放在心上，絕不食言',
  ...
  { id:'蘭斯洛特-Berserker', cls:'Berserker', realName:'蘭斯洛特（湖之騎士）', wars:['4th'], gender:'男',
    ...
    dailyLook:'黑髮・沉穩的男子身影、氣質略帶一絲憂鬱、話不多・語氣溫和有禮、私下總攬下最累的活，看到熟人時會露出難得的欣慰笑容',
  ...
  { id:'恩奇都-Lancer', cls:'Lancer', realName:'恩奇都', wars:['客串'], gender:'無',
    ...
    dailyLook:'青綠長髮・中性無垢的身影、氣質平和帶著一絲疏離感、自稱「我」・語氣平和中性卻藏著溫柔、私下總惦記著吉爾伽美什，會不自覺地歪頭觀察身邊的新奇事物',
  ...
  { id:'斯卡哈-Lancer', cls:'Lancer', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・妖豔冷峻的女子身影、氣質居高臨下卻自持有度、自稱「我」・偶爾露出揶揄語氣，帶著嚴師的威嚴、私下廚藝出乎意料地好，會不動聲色地照顧人',
  ...
  { id:'斯卡哈-Assassin', cls:'Assassin', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・冷冽優雅的女子身影、氣質慵懶自在中帶著一絲警覺、自稱「我」・說話低冷簡短・一針見血、私下偶爾會流露女王般的小得意，藏不住的可愛',
  ...
  { id:'美遊-Saber', cls:'Saber', realName:'美遊·埃德費爾特（Saber install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑髮・內斂的少女身影、氣質沉靜寡言、自稱「我」・寡言低語，不擅表達卻認真傾聽、私下手忙腳亂地想把事情做好，偶爾因此鬧出小笨拙',
  ...
  { id:'伊莉雅-Caster', cls:'Caster', realName:'伊莉雅絲菲爾·馮·愛因茲貝倫（Caster install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'白髮紅瞳・元氣滿滿的少女身影、氣質天真爛漫、自稱「我」・說話活潑直率・元氣滿滿、私下明明很愛哭，卻在重要時刻眼眶泛淚也要硬撐著勇敢',
  ...
  { id:'遠坂凜-Master', cls:'御主', realName:'遠坂凜', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑長雙馬尾・俐落幹練的少女身影、氣質傲然自信、自稱「我」・說話毒舌卻藏著關心、私下人後其實有點迷糊，會偷偷甩甩馬尾別過臉掩飾',
  ...
  { id:'伊莉雅絲菲爾-Master', cls:'御主', realName:'伊莉雅絲菲爾', wars:['客串'], gender:'女',
    ...
    dailyLook:'紅眼白髮的幼小少女身影、幾分警戒幾分親近的氣質、自稱「我」・說話孩子氣直率，偶爾透出早熟的敏銳、私下撒嬌功力一流，黏起人來讓人難以招架',
...
var CODEX_PERSONA_VER = 'v58'; // v58：玩家定案「日常衣裝獨立成欄，日常外貌改明確四段」，並提供10位角色的
