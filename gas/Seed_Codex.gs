...
var SEED_SERVANTS = [
  ...
  { id:'阿爾托莉雅-Saber', cls:'Saber', realName:'阿爾托莉雅·潘德拉貢', wars:['4th','5th'], gender:'女',
    ...
    dailyLook:'金髮碧眼・嬌小、背脊永遠打得筆直、簡潔認真略靦腆',
    dailyOutfit:'藏青連身洋裝',
  ...
  { id:'EMIYA-Archer', cls:'Archer', realName:'無名（EMIYA）', wars:['5th'], gender:'男',
    ...
    dailyLook:'褐膚白髮・冷峻、靠在門框上抱著手臂看人、嘴上嫌麻煩卻認真叮嚀',
    dailyOutfit:'深色休閒便服',
  ...
  { id:'庫丘林-Lancer', cls:'Lancer', realName:'庫·丘林', wars:['5th'], gender:'男',
    ...
    dailyLook:'藍髮赤瞳・精壯、爽朗常在街頭閒晃、自稱俺・豪爽粗獷',
    dailyOutfit:'花襯衫配輕便褲',
    dailyWords:'隨性自來熟、重情義、釣魚與湊熱鬧、拐彎抹角的算計',dailyMoe:'身手了得，卻老在小事上倒楣'} },
  { id:'美杜莎-Rider', cls:'Rider', realName:'美杜莎', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫長髮・高挑豐盈矯健、走路幾乎沒有聲音、寡言低沉卻藏溫柔',
  ...
  { id:'美狄亞-Caster', cls:'Caster', realName:'美狄亞', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫長髮・纖細清麗、說話時退著半步的距離、溫婉敬語裡帶小心翼翼',
    dailyOutfit:'溫柔色系洋裝',
  ...
  { id:'佐佐木小次郎-Assassin', cls:'Assassin', realName:'佐佐木小次郎', wars:['5th'], gender:'男',
    ...
    dailyLook:'紺髮長刀・清瘦劍客、走幾步就停下來看樹看雲、自稱拙者・慢條斯理偶帶禪意',
    dailyOutfit:'簡樸和風浴衣',
    dailyWords:'悠然風雅、隨遇而安、花鳥風月與閒聊、喧鬧紛擾',dailyMoe:'只有談到劍才突然較真'} },
  { id:'赫拉克勒斯-Berserker', cls:'Berserker', realName:'赫拉克勒斯', wars:['5th'], gender:'男',
    ...
    dailyLook:'岩肌巨軀・高大健壯、像座溫柔大山、話極少・多以點頭或單字回應',
    dailyOutfit:'特大號寬鬆休閒服',
    dailyWords:'沉默寡言、把人護在身後、搬重物與小孩、重要的人受委屈',dailyBack:'沉默溫和的大個子，小孩都愛纏著他',dailyMoe:'被道謝就侷促得不知手往哪擺'} },
  // 第四次
  ...
  { id:'吉爾伽美什-Archer', cls:'Archer', realName:'吉爾伽美什', wars:['4th'], gender:'男',
    ...
    dailyLook:'金髮赤瞳・俊美、走在街上像在視察領地、自稱吾・居高臨下卻難掩興致',
    dailyOutfit:'奢華名牌休閒服',
  ...
  { id:'迪盧木多-Lancer', cls:'Lancer', realName:'迪盧木多·奧迪那', wars:['4th'], gender:'男',
    ...
    dailyLook:'墨綠髮・俊美(面上一顆愛之痣)、進門總先替人扶著門、謙恭有禮情感壓在心底',
    dailyOutfit:'整潔的紳士便裝',
    dailyWords:'謙恭有禮、忠義與哀愁都藏著、堂堂正正的較量、趁人之危',dailyMoe:'天生惹人傾心，自己渾然不覺'} },
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾', wars:['4th'], gender:'男',
    ...
    dailyLook:'紅髮虬髯・魁梧、一坐下就佔滿半張長椅、自稱余・嗓門大愛大笑',
    dailyOutfit:'寬鬆披風外衣',
    dailyWords:'豪爽大氣、雅量裡藏孩子氣的野心、酒宴與高談闊論、小家子氣的計較',dailyMoe:'蒐集地圖，被碰到就急著搶回去'} },
  ...
  { id:'吉爾德萊-Caster', cls:'Caster', realName:'吉爾·德·萊斯', wars:['4th'], gender:'男',
    ...
    dailyLook:'清瘦貴族(無鬚無眉)・總抱著厚書、手指不停敲著桌面、談吐文雅入迷就激動',
  ...
  { id:'百貌哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（百貌）', wars:['4th'], gender:'男',
    ...
    dailyLook:'骷髏面具・深色裝扮的神秘身影、總站在光照不到的那一側、自稱我們・低語般說話偶爾換聲線',
    dailyOutfit:'剪裁俐落的深色裝扮',
    dailyWords:'低調神秘、多重人格意外和睦、安靜觀察、喧嘩張揚的場合',dailyMoe:'換個語氣就像換了個人'} },
  { id:'咒腕之哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（咒腕）', wars:['5th'], gender:'男',
    ...
    dailyLook:'骷髏面具・右臂纏繃帶、先站到看得見出口的位置、話極少必要時才開口',
    dailyOutfit:'深色簡樸裝扮',
  ...
  { id:'蘭斯洛特-Berserker', cls:'Berserker', realName:'蘭斯洛特', wars:['4th'], gender:'男',
    ...
    dailyLook:'黑髮・沉穩、收東西時把每樣都擺正、話不多・語氣溫和有禮',
    dailyOutfit:'整潔的深色便服',
  ...
  { id:'恩奇都-Lancer', cls:'Lancer', realName:'恩奇都', wars:['客串'], gender:'無',
    ...
    dailyLook:'青綠長髮・中性無垢、總赤著腳踩在草地上、語氣平和卻藏溫柔',
  ...
  { id:'斯卡哈-Lancer', cls:'Lancer', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・豐盈妖豔冷峻、抱著手臂從上往下打量、偶帶揶揄有嚴師威嚴',
  ...
  { id:'斯卡哈-Assassin', cls:'Assassin', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・豐盈冷冽優雅、半躺著也總對著門口、低冷簡短一針見血',
  ...
  { id:'美遊-Saber', cls:'Saber', realName:'美遊·埃德費爾特', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑髮・內斂、開口前會先握一下衣角、低語不擅表達卻認真傾聽',
    dailyOutfit:'藍色系簡約洋裝',
  ...
  { id:'小黑-Archer', cls:'Archer', realName:'克洛伊·馮·愛因茲貝倫', wars:['客串'], gender:'女',
    ...
    dailyLook:'褐膚白髮・活潑亮眼、倒著走路湊到人面前、自稱本小姐・促狹挑釁偶爾撒嬌耍賴',
    dailyOutfit:'活潑亮眼的休閒穿搭',
    dailyWords:'愛捉弄人、好勝卻重感情、捉弄的樂趣、被人小看',dailyBack:'促狹好勝，嘴硬又黏人',dailyMoe:'鬥嘴贏了會偷偷開心一整天'} },
  { id:'伊莉雅-Caster', cls:'Caster', realName:'伊莉雅絲菲爾·馮·愛因茲貝倫', wars:['客串'], gender:'女',
    ...
    dailyLook:'白髮紅瞳・元氣滿滿、一有興趣就整個人湊上去、活潑直率',
  ...
  { id:'遠坂凜-Master', cls:'御主', realName:'遠坂凜', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑長雙馬尾・勻稱俐落、下巴總是微抬半分、先挑毛病再給答案',
  ...
  { id:'伊莉雅絲菲爾-Master', cls:'御主', realName:'伊莉雅絲菲爾', wars:['客串'], gender:'女',
    ...
    dailyLook:'紅眼白髮的幼小少女、先躲在誰身後探頭看、孩子氣直率偶爾早熟',
  ...
  { id:'間桐櫻黑化-Master', cls:'御主', realName:'間桐櫻', wars:['客串'], gender:'女',
    ...
    dailyLook:'深紫長髮・玲瓏有致、雙手交疊在身前站得很直、語調輕柔偶藏小心機',
  ...
  { id:'衛宮士郎-Master', cls:'御主', realName:'衛宮士郎', wars:['客串'], gender:'男',
    ...
    dailyLook:'紅褐短髮的高中生、袖子總是捲到手肘、直率溫和',
  ...
  { id:'藤村大河-Master', cls:'御主', realName:'藤村大河', wars:['客串'], gender:'女',
    ...
    dailyLook:'亞麻色及肩短髮・嬌小、走路帶風，包包甩著晃、中氣十足帶得意',
...
var CODEX_PERSONA_VER = 'v77'; // v77：21 筆「氣質舉止」從純形容詞改寫成看得到的畫面（純形容詞比例 88%→12%）。
