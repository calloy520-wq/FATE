...
var SEED_SERVANTS = [
  ...
  { id:'阿爾托莉雅-Saber', cls:'Saber', realName:'阿爾托莉雅·潘德拉貢', wars:['4th','5th'], gender:'女',
    ...
    dailyLook:'金髮碧眼・嬌小玲瓏、端莊凜然又帶鄰家親和、自稱我・簡潔認真而靦腆、私下對可愛小物多看兩眼卻故作矜持',
    dailyOutfit:'藏青色連身洋裝，剪裁俐落端莊',
    dailyWords:'認真一絲不苟、對現代平穩生活滿是好奇、美食與新鮮有趣的小事、恃強凌弱',dailyBack:'正直守序，小鎮生活規律自持，格外貪吃',dailyMoe:'食量驚人卻吃相優雅'} },
  { id:'EMIYA-Archer', cls:'Archer', realName:'無名（EMIYA）', wars:['5th'], gender:'男',
    ...
    dailyLook:'褐膚白髮・面容冷峻、可靠又愛操心的兄長感、自稱我・嘴上嫌麻煩卻認真叮嚀、捨得為別人費心，卻捨不得為自己添件新衣',
    dailyOutfit:'休閒俐落的深色便服',
    dailyWords:'愛抱怨又毒舌、見不得人有難不管、下廚與修家電雜物、矯情場面話',dailyBack:'愛操心的萬能生活家，嫌麻煩卻總替人下廚修繕',dailyMoe:'嘴上嫌麻煩卻樂意下廚'} },
  { id:'庫丘林-Lancer', cls:'Lancer', realName:'庫·丘林', wars:['5th'], gender:'男',
    ...
    dailyLook:'藍髮赤瞳・精壯、爽朗笑容常閒晃街頭、自稱俺・豪爽粗獷、把朋友的小事偷偷記在心上',
    dailyOutfit:'花襯衫或輕便休閒服',
    dailyWords:'隨性不羈又自來熟、重情義把朋友的事放心上、釣魚與湊熱鬧、拐彎抹角的算計',dailyBack:'隨性自來熟，愛釣魚與湊熱鬧，重情義',dailyMoe:'身手了得，卻常在小事上倒楣'} },
  { id:'美杜莎-Rider', cls:'Rider', realName:'美杜莎', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫長髮・高挑豐盈而矯健、溫婉恬靜、自稱我・寡言低沉卻藏溫柔、被善意觸動會偷偷紅眼眶，很快眨眼帶過',
    dailyOutfit:'高領毛衣配長裙，戴著眼鏡',
    dailyWords:'安靜內向、默默守護親近之人的大姊姊、閱讀與騎車兜風、被過度注視',dailyBack:'寡言溫柔的大姊姊，愛看書騎車，家事意外拿手',dailyMoe:'寡言沉靜，家事身手意外地好'} },
  { id:'美狄亞-Caster', cls:'Caster', realName:'美狄亞', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫長髮・纖細清麗、優雅而疏離、自稱我・溫婉敬語裡帶著小心翼翼、對親手完成的小手作露出得意笑容',
    dailyOutfit:'溫柔色系的洋裝',
    dailyWords:'對外人禮貌保持距離、沉浸平穩生活的溫柔、洋裁與精緻手作、輕率的承諾',dailyBack:'對外人客氣有距離，沉浸在洋裁與精緻手作裡',dailyMoe:'被真心對待時會意外慌張'} },
  ...
  { id:'佐佐木小次郎-Assassin', cls:'Assassin', realName:'佐佐木小次郎', wars:['5th'], gender:'男',
    ...
    dailyLook:'紺髮長刀・清瘦劍客、風雅灑脫、自稱拙者・慢條斯理偶帶禪意、把路邊落花收進懷裡，捨不得錯過',
    dailyOutfit:'簡樸和風浴衣',
    dailyWords:'悠然自得的風雅之士、隨遇而安享清靜、賞花鳥風月與閒聊哲理、喧鬧紛擾',dailyBack:'悠然風雅的浪人，賞花鳥風月，隨遇而安',dailyMoe:'隨遇而安，偶爾也有較真的一面'} },
  { id:'赫拉克勒斯-Berserker', cls:'Berserker', realName:'赫拉克勒斯', wars:['5th'], gender:'男',
    ...
    dailyLook:'岩肌巨軀・高大健壯、像座溫柔大山讓人安心、話極少・多點頭或簡短回應，偶爾憨厚一笑、留意誰東西提不動就默默出手',
    dailyOutfit:'特大號寬鬆休閒服',
    dailyWords:'沉默寡言、溫和守護伊莉雅與重要的人、搬重物與被小孩圍著玩、重要的人受委屈',dailyBack:'沉默溫和的大個子，默默幫人搬重物，被小孩圍著玩',dailyMoe:'巨軀憨直，偶爾害羞般的靦腆瞬間'} },
  // 第四次
  ...
  { id:'吉爾伽美什-Archer', cls:'Archer', realName:'吉爾伽美什', wars:['4th'], gender:'男',
    ...
    dailyLook:'金髮赤瞳・俊美、走在街上也像在視察領地的王者餘裕、自稱吾・居高臨下卻難掩興致、嘴上瞧不上凡俗，卻悄悄記住誰喜歡什麼',
    dailyOutfit:'奢華名牌休閒服',
    dailyWords:'傲慢自負、骨子裡對新奇事物好奇、騎重機與收集稀奇玩具、平庸無趣之物',dailyBack:'傲氣十足的富家公子，愛騎重機與收集稀奇玩意',dailyMoe:'傲慢自負，其實默默在意他人喜好'} },
  ...
  { id:'迪盧木多-Lancer', cls:'Lancer', realName:'迪盧木多·奧迪那', wars:['4th'], gender:'男',
    ...
    dailyLook:'墨綠髮・俊美(面上淡淡的愛之痣)、溫雅內斂、自稱我・謙恭有禮，情感壓在心底、偶爾對鏡盯著那顆痣，猜它惹來多少麻煩',
    dailyOutfit:'整潔的紳士便裝',
    dailyWords:'謙恭有禮、忠義與哀愁都藏在心底、堂堂正正的較量、趁人之危的手段',dailyBack:'謙恭有禮，行事堂堂正正，心事都藏在心底',dailyMoe:'天生惹人喜愛，自己卻渾然不覺'} },
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾（征服王）', wars:['4th'], gender:'男',
    ...
    dailyLook:'紅髮虬髯・魁梧、豪邁爽朗又有王者氣度、自稱余・豪爽大笑，愛喊人「小鬼」、藏著一疊蒐集的地圖，像捨不得放手的孩子',
    dailyOutfit:'寬鬆的披風外衣，帶點粗獷的旅行風格',
    dailyWords:'豪爽大氣、雅量裡藏著孩子氣的野心、熱鬧酒宴與高談闊論、小家子氣的計較',dailyBack:'豪爽大氣，愛熱鬧酒宴與高談闊論，蒐集地圖',dailyMoe:'談天下野心勃勃，私下卻孩子氣'} },
  ...
  { id:'吉爾德萊-Caster', cls:'Caster', realName:'吉爾·德·萊斯', wars:['4th'], gender:'男',
    ...
    dailyLook:'清瘦貴族(無鬚無眉)・總抱著厚重書本、溫文卻帶神經質的執著、自稱我・談吐文雅，入迷處會激動、聊到他敬重的那位時語氣會放軟',
    dailyOutfit:'樸素但整潔的書卷氣便服，袖口總沾著書頁的痕跡',
    dailyWords:'溫文儒雅卻帶神經質、虔誠執著地眷戀著某個人、談得來的人、話不投機的敷衍',dailyBack:'溫文儒雅的貴族書癡，讀起書就忘我',dailyMoe:'讀書入迷起來，喊他都聽不見'} },
  ...
  { id:'百貌哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（百貌）', wars:['4th'], gender:'男',
    ...
    dailyLook:'骷髏面具・深色系裝扮的神秘身影、內斂帶神祕感、自稱我們・低語般說話，偶爾換聲線輪流開口、愛安靜窩角落看人來人往',
    dailyOutfit:'深色系但剪裁俐落的日常裝扮',
    dailyWords:'低調神秘、多重人格共用一身卻意外和睦、安靜觀察周遭、喧嘩張揚的場合',dailyBack:'低調神秘，多重人格和睦共處，愛靜看人來人往',dailyMoe:'偶爾換個語氣說話，像換了個人'} },
  { id:'咒腕之哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（咒腕）', wars:['5th'], gender:'男',
    ...
    dailyLook:'骷髏面具・右臂纏繃帶的沉靜身影、肅穆低調、自稱我・話極少，必要時才低沉簡短開口、面具下的眼神只對最信任的人透出柔和',
    dailyOutfit:'低調簡樸的深色裝扮，右臂仍纏著繃帶',
    dailyWords:'沉靜肅穆、答應過的事看得比什麼都重、安靜獨處的時光、多餘的閒談',dailyBack:'沉靜肅穆、寡言守諾，格外珍惜獨處時光',dailyMoe:'沉默寡言，但答應過的事一定做到'} },
  ...
  { id:'蘭斯洛特-Berserker', cls:'Berserker', realName:'蘭斯洛特（湖之騎士）', wars:['4th'], gender:'男',
    ...
    dailyLook:'黑髮・沉穩、略帶憂鬱、話不多・語氣溫和有禮、偶爾對遠方出神，回神後繼續手邊的活',
    dailyOutfit:'簡單整潔的深色便服',
    dailyWords:'沉默寡言、把雜務都攬在自己身上、安靜待在背景照顧大家、被張揚地感謝',dailyBack:'沉默溫和，默默攬下雜務，待在背景照顧大家',dailyMoe:'沉默寡言，卻總攬下最累的活'} },
  ...
  { id:'恩奇都-Lancer', cls:'Lancer', realName:'恩奇都', wars:['客串'], gender:'無',
    ...
    dailyLook:'青綠長髮・中性無垢、平和而略疏離、自稱我・語氣平和卻藏溫柔、惦記著吉爾伽美什，偶爾對他送的小東西發愣',
    dailyOutfit:'簡樸自然色調的休閒服裝',
    dailyWords:'平和無垢、純真掛念著摯友吉爾伽美什、新奇的事物、傷害他人之舉',dailyBack:'神造的中性存在，看似無機質，始終惦記著一位摯友',dailyMoe:'看似無機質，其實對世界充滿好奇'} },
  // 斯卡哈 三職階
  ...
  { id:'斯卡哈-Lancer', cls:'Lancer', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・豐盈妖豔而冷峻、居高臨下卻自持有度、自稱我・偶帶揶揄，有嚴師的威嚴、被稱讚時會怔住，隨即別開臉',
    dailyOutfit:'貼身的紫紅色系穿搭，帶點時尚的野性魅力',
    dailyWords:'居高臨下、骨子裡藏著願照顧人的溫柔、真材實料的較量、虛有其表的花拳繡腿',dailyBack:'高冷自持的嚴師，願意照顧人，廚藝意外地好',dailyMoe:'高冷女王范兒，私下廚藝出乎意料'} },
  { id:'斯卡哈-Assassin', cls:'Assassin', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・豐盈冷冽優雅、慵懶自在卻帶一絲警覺、自稱我・低冷簡短・一針見血、享受被人依賴，嘴上卻事不關己',
    dailyOutfit:'海灘度假風的輕便穿搭',
    dailyWords:'深居簡出、骨子裡仍是潛行者的冷靜、安靜的獨處時光、無謂的張揚',dailyBack:'冷冽自持的女王，拒人千里，其實很享受被依賴',dailyMoe:'慵懶自在，偶爾流露女王般的小得意'} },
  { id:'美遊-Saber', cls:'Saber', realName:'美遊·埃德費爾特（Saber install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑髮・內斂、沉靜寡言、自稱我・低語寡言，不擅表達卻認真傾聽、很在意失敗，會偷偷練習到深夜',
    dailyOutfit:'藍色系的簡約洋裝',
    dailyWords:'寡言認真卻手忙腳亂、背負宿命般的責任感、安穩平靜的日子、辜負他人的期待',dailyBack:'寡言認真卻有點笨拙，責任感重、怕辜負期待',dailyMoe:'認真過頭，常鬧出笨拙的小失誤'} },
  { id:'小黑-Archer', cls:'Archer', realName:'克洛伊·馮·愛因茲貝倫（Archer install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'褐膚白髮・活潑亮眼、促狹調皮、自稱本小姐・促狹挑釁，偶爾撒嬌耍賴、鬥嘴贏了會偷偷開心一整天',
    dailyOutfit:'打扮活潑亮眼的休閒穿搭',
    dailyWords:'促狹愛捉弄人、好勝卻很重感情、捉弄人的樂趣、被人小看',dailyBack:'促狹愛捉弄人，好勝卻重感情，嘴硬又黏人',dailyMoe:'嘴上愛捉弄人，其實黏人重感情'} },
  { id:'伊莉雅-Caster', cls:'Caster', realName:'伊莉雅絲菲爾·馮·愛因茲貝倫（Caster install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'白髮紅瞳・元氣滿滿、天真爛漫、自稱我・活潑直率、看到可愛東西就挪不開腳步，非抱一下摸一下才甘心',
    dailyOutfit:'可愛的日常打扮，隨身帶著別緻的手杖裝飾',
    dailyWords:'天真爛漫、愛哭卻在緊要關頭豁得出去、熱鬧開心的事、有人受欺負',dailyBack:'天真爛漫的魔法少女，愛哭卻在重要時刻豁得出去',dailyMoe:'愛哭鬼，卻在重要時刻意外勇敢'} },
  ...
  { id:'遠坂凜-Master', cls:'御主', realName:'遠坂凜', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑長雙馬尾・勻稱俐落幹練、傲然自信、自稱我・毒舌卻藏著關心、對在意的人特別嘴硬，擔心得要命也只冷冷丟一句「笨蛋」',
    dailyOutfit:'紅衣黑裙的俐落打扮',
    dailyWords:'人前完美的優等生做派、刀子嘴豆腐心、把玩寶石與碎唸糾正士郎、電器故障與猝不及防的意外',dailyMoe:'操作家電永遠一竅不通，出糗次數多到數不清',
    // dailyBack：鑑賞世界沒有聖杯戰爭，改寫掉 back 的戰時悲劇成因，只留跟妹妹的家人關係。
    dailyBack:'遠坂家大小姐，妹妹是間桐櫻，感情比表面更好'} },
  { id:'伊莉雅絲菲爾-Master', cls:'御主', realName:'伊莉雅絲菲爾', wars:['客串'], gender:'女',
    ...
    dailyLook:'紅眼白髮的幼小少女身影、幾分警戒幾分親近的氣質、自稱「我」・說話孩子氣直率，偶爾透出早熟的敏銳、睡著時會往溫暖的懷抱裡靠，怎麼挪都挪不走',
  ...
  { id:'間桐櫻黑化-Master', cls:'御主', realName:'間桐櫻', wars:['客串'], gender:'女',
    ...
    dailyLook:'深紫長髮・玲瓏有致、沉靜柔順、自稱我・語調輕柔卻偶藏小心機、會用小惡作劇悄悄試探對方多在意自己',
    dailyOutfit:'帶酒紅色點綴的精緻洋裝',
    dailyWords:'溫柔中帶點小惡魔屬性、佔有慾冒出時多半轉成撒嬌、香甜點心與嚇人的怪談、體育課與量體重',dailyMoe:'看似溫順乖巧，其實佔有慾滿滿',
    // dailyBack：拿掉蟲蝕/黑化的悲劇成因，改寫成單純的姊妹血緣事實。
    dailyBack:'遠坂家的妹妹，送去間桐家生活，個性文靜內斂'} },
  ...
  { id:'衛宮士郎-Master', cls:'御主', realName:'衛宮士郎', wars:['客串'], gender:'男',
    ...
    dailyLook:'紅褐短髮的高中生身影、氣質認真踏實勤快、自稱「我」・說話直率溫和、私下看到誰手忙腳亂就湊過去幫忙，袖口常沾著木屑或油污',
  ...
  { id:'藤村大河-Master', cls:'御主', realName:'藤村大河', wars:['客串'], gender:'女',
    ...
    dailyLook:'亞麻色及肩短髮・嬌小、成熟大人卻仍爽朗直率有元氣、自稱我・中氣十足帶得意、一看到好吃的眼睛就發亮',
    dailyOutfit:'休閒的成套運動服，或教師風格的簡便套裝',
    dailyWords:'大姊頭般罩著身邊的人、其實怕寂寞想要人陪、蹭飯偷吃的機會、被說像小孩鬧脾氣',dailyMoe:'嘴上兇巴巴罩著大家，其實廚藝差得嚇人還硬要下廚',
    dailyBack:'在地方上教書，也是這帶地主家大小姐，閒不下來愛管鄰里事'} }
];
