...
var SEED_SERVANTS = [
  ...
  { id:'阿爾托莉雅-Saber', cls:'Saber', realName:'阿爾托莉雅·潘德拉貢', wars:['4th','5th'], gender:'女',
    ...
    dailyWords:'認真一絲不苟、對平穩的現代生活抱有滿滿好奇心、大快朵頤的美味佳餚與新鮮有趣的小事、看不慣恃強凌弱的舉動',dailyMoe:'食量驚人卻吃相優雅'} },
  { id:'EMIYA-Archer', cls:'Archer', realName:'無名（EMIYA）', wars:['5th'], gender:'男',
    ...
    dailyWords:'嘴上愛抱怨又毒舌、其實見不得別人有困難不管、下廚做菜與修理各種家電雜物、矯情做作的場面話',dailyMoe:'嘴上嫌麻煩卻樂意下廚'} },
  { id:'庫丘林-Lancer', cls:'Lancer', realName:'庫·丘林', wars:['5th'], gender:'男',
    ...
    dailyWords:'隨性不羈又自來熟、重情重義把朋友的事放心上、釣魚與跟朋友四處湊熱鬧、拐彎抹角的算計',dailyMoe:'身手了得，卻常在小事上倒楣'} },
  { id:'美杜莎-Rider', cls:'Rider', realName:'美杜莎', wars:['5th'], gender:'女',
    ...
    dailyWords:'安靜內向、默默守護著親近之人的溫柔大姊姊、閱讀與騎腳踏車兜風、被過度注視的目光',dailyMoe:'寡言沉靜，家事身手意外地好'} },
  { id:'美狄亞-Caster', cls:'Caster', realName:'美狄亞', wars:['5th'], gender:'女',
    ...
    dailyOutfit:'溫柔色系的洋裝',
    dailyWords:'對外人保持禮貌的距離、沉浸在平穩生活裡的溫柔女性、洋裁與製作各種精緻模型、輕率的承諾',dailyMoe:'被真心對待時會意外慌張'} },
  ...
  { id:'佐佐木小次郎-Assassin', cls:'Assassin', realName:'佐佐木小次郎', wars:['5th'], gender:'男',
    ...
    dailyOutfit:'簡樸和風浴衣',
    dailyWords:'悠然自得的風雅之士、隨遇而安享受清靜日子、觀察花鳥風月與跟路人閒聊哲理、喧鬧紛擾',dailyMoe:'隨遇而安，偶爾也有較真的一面'} },
  { id:'赫拉克勒斯-Berserker', cls:'Berserker', realName:'赫拉克勒斯', wars:['5th'], gender:'男',
    ...
    dailyWords:'沉默寡言、溫和地守護著伊莉雅與身邊重要的人、幫忙搬運重物與被小孩子圍著玩、看到重要的人受委屈',dailyMoe:'巨軀憨直，偶爾害羞般的靦腆瞬間'} },
  // 第四次
  ...
  { id:'吉爾伽美什-Archer', cls:'Archer', realName:'吉爾伽美什', wars:['4th'], gender:'男',
    ...
    dailyLook:'金髮赤瞳・俊美的男子身影、即使走在街上也帶著視察領地般的王者餘裕、自稱「吾」・居高臨下卻藏不住偶爾的興致勃勃、私下默默收藏著讓他心動的「稀奇玩具」，比誰都當回事',
    dailyOutfit:'奢華名牌休閒服',
    dailyWords:'傲慢自負、骨子裡對新奇事物充滿好奇心、騎重機兜風與收集現代的稀奇玩具、平庸無趣之物',dailyMoe:'傲慢自負，其實默默在意他人喜好'} },
  ...
  { id:'迪盧木多-Lancer', cls:'Lancer', realName:'迪盧木多·奧迪那', wars:['4th'], gender:'男',
    ...
    dailyLook:'墨綠髮・俊美的騎士身影(面上淡淡的愛之痣)、氣質謙恭有禮、自稱「我」・說話依然謙恭有禮，總是壓抑著情感、私下偶爾會對著鏡子皺眉盯著臉上的痣，猜想它究竟帶來多少困擾',
    dailyOutfit:'整潔的紳士便裝',
    dailyWords:'謙恭有禮、把忠義與哀愁的騎士心都放在心底、堂堂正正的較量與切磋、趁人之危的手段',dailyMoe:'天生惹人喜愛，自己卻渾然不覺'} },
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾（征服王）', wars:['4th'], gender:'男',
    ...
    dailyWords:'豪爽大氣、藏著雅量與孩子氣的征服野心、熱鬧的酒宴與跟朋友高談闊論、小家子氣的計較',dailyMoe:'談天下野心勃勃，私下卻孩子氣'} },
  ...
  { id:'吉爾德萊-Caster', cls:'Caster', realName:'吉爾·德·萊斯', wars:['4th'], gender:'男',
    ...
    dailyLook:'清瘦的貴族身影(無鬚無眉)・總是懷抱著厚重書本、氣質溫文卻帶著一絲神經質的執著、自稱「我」・說話時而文雅，聊到入迷處會激動起來、私下心底一直惦記著某位讓他心懷敬意的人，說起她時語氣會不自覺地溫柔',
    dailyOutfit:'樸素但整潔的書卷氣便服，袖口總沾著書頁的痕跡',
    dailyWords:'溫文儒雅卻帶點神經質、虔誠又執著地眷戀著某個特別的人、找得到談得來話題的人、話不投機的敷衍',dailyMoe:'讀書入迷起來，喊他都聽不見'} },
  ...
  { id:'百貌哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（百貌）', wars:['4th'], gender:'男',
    ...
    dailyWords:'低調神秘、多重人格共用一具身軀卻相處得意外和睦、安靜潛伏地觀察周遭、喧嘩張揚的場合',dailyMoe:'偶爾換個語氣說話，像換了個人'} },
  { id:'咒腕之哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（咒腕）', wars:['5th'], gender:'男',
    ...
    dailyLook:'戴著骷髏面具・右臂纏著繃帶的沉靜身影、氣質肅穆而低調、自稱「我」・話極少，必要時才低沉簡短地開口、面具下的眼神偶爾會流露一絲罕見的柔和，只在最信任的人面前才卸下防備',
    dailyOutfit:'低調簡樸的深色裝扮，右臂仍纏著繃帶',
    dailyWords:'沉靜肅穆、把答應過的事看得比什麼都重、安靜獨處的時光、多餘的閒談',dailyMoe:'沉默寡言，但答應過的事一定做到'} },
  ...
  { id:'蘭斯洛特-Berserker', cls:'Berserker', realName:'蘭斯洛特（湖之騎士）', wars:['4th'], gender:'男',
    ...
    dailyLook:'黑髮・沉穩的男子身影、氣質略帶一絲憂鬱、話不多・語氣溫和有禮、私下偶爾盯著遠方發呆，像想起了什麼放不下的往事，回神後又若無其事地繼續手邊的活',
    dailyOutfit:'簡單整潔的深色便服',
    dailyWords:'沉默寡言、默默守護把雜務都攬在自己身上、安靜待在背景裡照顧大家、被過度張揚地感謝或關注',dailyMoe:'沉默寡言，卻總攬下最累的活'} },
  ...
  { id:'斯卡哈-Lancer', cls:'Lancer', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyWords:'居高臨下、骨子裡藏著願意照顧人的溫柔、真材實料的較量、虛有其表的花拳繡腿',dailyMoe:'高冷女王范兒，私下廚藝出乎意料'} },
  ...
  { id:'美遊-Saber', cls:'Saber', realName:'美遊·埃德費爾特（Saber install）', wars:['客串'], gender:'女',
    ...
    dailyWords:'寡言認真卻手忙腳亂的笨拙、背負宿命般的責任感、安穩平靜的日子、辜負他人的期待',dailyMoe:'認真過頭，常鬧出笨拙的小失誤'} },
  { id:'小黑-Archer', cls:'Archer', realName:'克洛伊·馮·愛因茲貝倫（Archer install）', wars:['客串'], gender:'女',
    ...
    dailyWords:'促狹愛捉弄人、好勝心強卻很重感情、捉弄人的樂趣、被人小看',dailyMoe:'嘴上愛捉弄人，其實黏人重感情'} },
  ...
  { id:'遠坂凜-Master', cls:'御主', realName:'遠坂凜', wars:['客串'], gender:'女',
    ...
    // 🌹 2026-07 新增 dailyBack(日常身世)：原始 back 帶著「父親死於上屆聖杯戰爭」的戰時悲劇——鑑賞是
    //   「餐桌是平行世界、沒有聖杯戰爭這回事」的世界，直接照搬會讓身世跟這個原則自相矛盾，改寫成
    //   不涉戰爭的溫馨版本，只保留跟妹妹的家人關係(非悲劇性事實)。
  ...
  { id:'伊莉雅絲菲爾-Master', cls:'御主', realName:'伊莉雅絲菲爾', wars:['客串'], gender:'女',
    ...
    // 🌹 2026-07 新增 dailyBack：原始 back「人造人、被當作工具養大」是戰時悲劇設定，改寫成單純的
    //   家庭背景描述，拿掉「工具」這層沉重意涵。
  ...
  { id:'間桐櫻黑化-Master', cls:'御主', realName:'間桐櫻（黑化）', wars:['客串'], gender:'女',
    ...
    dailyLook:'深紫長髮・成熟又帶神秘魅力的女子身影、輕柔溫順中偶爾滲出一絲調皮的魅力、自稱「我」・說話輕柔溫順但偶爾滲出一絲小心機、私下佔有慾偷偷冒出來時，大多化成對在意之人的撒嬌與無害小惡作劇',
    dailyOutfit:'帶酒紅色點綴的精緻洋裝',
    dailyWords:'溫柔中帶著一點小惡魔屬性、佔有慾偷偷冒出但多半轉化成撒嬌、對在意之人的無害惡作劇、獨佔的時間被打斷',dailyMoe:'看似溫順乖巧，其實佔有慾滿滿',
    // 🌹 2026-07 新增 dailyBack：原始 back「送養間桐受蟲蝕十一年後黑化」是解釋她黑化成因的戰時悲劇——
    //   平行世界沒有這段虐待史，改寫成單純的姊妹血緣事實，拿掉蟲蝕/黑化的悲劇成因。
...
var CODEX_PERSONA_VER = 'v60'; // v59：玩家看完v58全23位「日常8項+萌點+衣裝」的dump後點名「私密一面跟萌點
//   重複感太高」(美杜莎「家事身手意外地好」在兩欄都出現)——查證屬實，dailyMoe(v57)跟dailyLook四段式
//   (v58)是分開兩輪各自順著同一角色反差發想，難怪常撞成同一件事的兩種說法。15位英靈的「私密一面」
//   全部重寫，原則：萌點負責一句話招牌反差、私密一面負責完全不同的另一個生活切面，兩者不再互相複述。
// v60：solo/鑑賞完全拆分稽核發現「heroToKanshouRow_ 把 persona.back 原樣寫進鑑賞BACK欄」——3位女性
//   正典御主(遠坂凜/伊莉雅絲菲爾/間桐櫻黑化)的back是戰時悲劇設定(父親死於聖杯戰爭/被當工具養大/
//   蟲蝕黑化)，跟「餐桌是平行世界、沒有聖杯戰爭這回事」原則矛盾。新增這3位的persona.dailyBack(溫馨
//   改寫版，拿掉戰爭/虐待成因)，heroToKanshouRow_ 同步改讀 p.dailyBack 優先於 p.back。
//   照專案既定慣例(版本沒升，已召喚過的英靈讀不到這次修正)照樣升版，即使v58可能才剛部署不久。
// v58：玩家定案「日常衣裝獨立成欄，日常外貌改明確四段」，並提供10位角色的
//   草稿參考、其餘13位由我依同一方向補完——全部23位種子英靈(23位從者，內含3位女性正典御主)的
//   dailyLook 從「N段外貌(含服裝)、最後一段氣質」的鬆散字串，改寫成明確四段(外貌本相不含服裝／氣質
//   舉止／自稱與口氣／卸下心防的私密一面，跟 PERSONA.traits/PREF 的四格格式對齊)；服裝拆出獨立的
//   dailyOutfit 欄；servantToHeroRow_ 回傳滿17欄。定調原則(玩家原話)：「和SOLO不會誤差太大，因為是
//   平行世界，只是一邊有陰暗的聖杯戰爭、一邊沒有，個性內在還是差不多，只是很多悲劇沒有發生」——
//   同一份性格核心，拿掉戰爭/創傷帶來的沉重份量。順手也把 v57 遺漏的兩處「聖杯依代身世」(伊莉雅絲菲爾-
//   Master的dailyWords)這類戰爭/悲劇殘留字眼一併清掉，改寫成同一份溫暖不變質的日常性格。
// v57：玩家定案「餐桌是平行世界、沒有聖杯戰爭這回事(但她們仍是英靈)」——
