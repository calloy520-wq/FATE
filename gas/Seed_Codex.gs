...
var SEED_MASTERS = [
  ...
  {id:'遠坂凜-5th',    name:'遠坂凜', gender:'女', appearance:'黑長雙馬尾、紅衣黑裙，傲然',     war:'5th', magic:'寶石魔術',            circuits:50, melee:'C', magic_rank:'A', home:'遠坂宅',     wish:'見證聖杯・不負遠坂之名',  persona:'人前完美的優等生・刀子嘴豆腐心・喜歡可愛小物與紅茶・厭惡示弱與失態', back:'冬木名門遠坂家長女，父親時臣死於上屆聖杯戰爭，背負遠坂的驕傲與正統魔術師之道', moe:'人前完美人後迷糊、傲嬌到極致、其實很怕寂寞、偷偷存錢買可愛小物還嘴硬'},
  ...
  {id:'間桐臟硯-5th',  name:'間桐臟硯', gender:'男', appearance:'乾癟矮小的千年老人，蟲蝕枯槁之軀', war:'5th', magic:'間桐之蟲術・吸血蟲・延命', circuits:40, melee:'E', magic_rank:'A', home:'間桐宅',     wish:'逃脫死亡（不老不死）・視奪杯為餘生消遣', persona:'乾癟陰沉的老謀深算・對活下去的病態執著・喜歡操弄與蟲蝕・厭惡死亡與軟弱', back:'活了五百年的間桐家始祖（本名佐爾根），以蟲術苟延殘喘、視子孫為延命容器，為奪聖杯不擇手段', moe:'千年老者的執念與算計、視人命如棋子的冷酷、對「活下去」的病態渴求、陰森的耐性'},
  ...
  {id:'間桐櫻(黑化)-5th',name:'間桐櫻（黑化）', gender:'女', appearance:'黑長髮、黑紅禮服，妖異而空洞的笑',war:'5th',magic:'聖杯之泥・無限魔力・蟲爪', circuits:50, melee:'E', magic_rank:'A', home:'間桐宅', wish:'獨佔所愛、將傷害自己的世界一同拖入黑暗', persona:'溫順乖巧的假面・被黑泥吞噬的佔有・渴望獨佔所愛・厭惡傷害過自己的一切', back:'遠坂家次女，自幼被送養給間桐家承受蟲蝕之苦十一年，長期壓抑終被聖杯黑泥侵蝕黑化', moe:'純愛扭曲成毀滅性佔有的反差、乖巧外表下的瘋狂、對姊姊與學長的複雜執念、可憐又可怖'},
  // 第四次
  // ⚠ 2026-07 修：circuits35→15、magic_rank B→C——他的魔術回路數量少質量也差(原作明寫、故Saber供魔得靠愛麗絲)，
  //   真正的殺傷力來自起源彈與戰術而非魔術本身，「天才殺手·蹩腳魔術師」的反差不該被回路數字掩蓋。
  {id:'衛宮切嗣-4th',  name:'衛宮切嗣', gender:'男', appearance:'黑髮疲憊的男人，風衣',   war:'4th', magic:'起源彈・固有時制御',    circuits:15, melee:'A', magic_rank:'C', home:'冬木·深山町', wish:'以聖杯拯救世界、終結戰爭',persona:'冷酷疲憊的魔術師殺手・為大義不擇手段・喜歡（曾經）平凡的幸福・厭惡無謂的犧牲', back:'信奉「拯救多數而犧牲少數」的魔術師殺手，為終結一切戰爭而尋求聖杯，背負「拯救多數犧牲少數」的沉重覺悟參戰', moe:'冷酷算計下對家人的溫柔、理想與手段的痛苦矛盾、抽菸沉思的疲憊、其實最痛恨殺戮'},
  ...
  {id:'肯尼斯-4th',    name:'肯尼斯', gender:'男', appearance:'金髮高傲的年輕教授',     war:'4th', magic:'礦石科・流體操作',      circuits:65, melee:'C', magic_rank:'A', home:'冬木·新都（海特飯店）', wish:'榮譽與學術成就',          persona:'高傲的天才教授・極高的自尊・喜歡學術與名譽・厭惡被輕視', back:'時鐘塔礦石科年輕天才講師，攜未婚妻索菈參戰，自視甚高、絕不容許在這場戰爭裡蒙受任何屈辱', moe:'天才的傲慢與脆弱自尊、對未婚妻意外的深情、被打臉時的崩潰、學究的一板一眼'},
  // ⚠ 2026-07 修：home補「麥肯基宅」(他借住深山町山丘上的老夫婦家，非新都鬧區)；circuits25→15(原作明寫他是時鐘塔墊底的資質，跟肯尼斯拉開懸殊差距)。
  {id:'韋伯·維爾維特-4th',name:'韋伯·維爾維特', gender:'男', appearance:'黑髮瘦小的少年魔術師',war:'4th',magic:'自我暗示・基礎魔術', circuits:15, melee:'E', magic_rank:'C', home:'冬木·深山町（麥肯基宅）', wish:'證明自己的價值',          persona:'故作老成的少年・自卑卻好強・喜歡證明自己・厭惡被當作無能', back:'出身平凡的時鐘塔末席學生，為證明「才能非血統決定」偷走觸媒召喚出與自己羈絆深厚的英靈，一路成長', moe:'嘴硬的自卑少年、被並肩的從者一路磨礪帶著成長、口嫌體正直、偷偷崇拜那位豪邁的英靈'},
  // ⚠ 2026-07 修：wish原「召喚惡魔」是誤植——他對聖杯毫無興趣，真正圖的是跟從者一起體驗新奇殺戮的快感；home補實際據點(澪標川下水道廢棄工房，非新都鬧區)。
  {id:'雨生龍之介-4th',name:'雨生龍之介', gender:'男', appearance:'輕浮的金髮青年，咧嘴而笑', war:'4th', magic:'無魔術・召喚術（外行）', circuits:10, melee:'C', magic_rank:'E', home:'冬木·澪標川（廢棄工房）', wish:'見識更新奇的殺戮・與從者共享獵奇的快感',persona:'輕浮開朗的青年・天生純粹之惡・喜歡有趣與新鮮的死亡・厭惡無聊', back:'毫無魔術素養卻天生純粹的殺人狂，誤打誤撞召喚出與自己瘋狂共鳴的英靈，把殺戮當成有趣的遊戲', moe:'開朗笑容下的純粹瘋狂、對「有趣」孩子般的好奇、與其從者的瘋狂默契、毫無惡意的惡'},
...
var CODEX_PERSONA_VER = 'v44'; // v44：御主庫(SEED_MASTERS)首次深度校對(玩家2026-07要求·3組研究agent逐條查證+親自複核)——
