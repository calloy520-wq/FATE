...
var SEED_SERVANTS = [
  ...
  { id:'阿爾托莉雅-Saber', cls:'Saber', realName:'阿爾托莉雅·潘德拉貢', wars:['4th','5th'], gender:'女',
    ...
    dailyLook:'金髮碧眼・身形嬌小玲瓏的少女身影、端莊凜然中帶著鄰家女孩的親和感、自稱「我」・說話簡潔認真，少女心的靦腆、私下看到可愛的小東西會多看兩眼，會故作矜持',
  ...
  { id:'EMIYA-Archer', cls:'Archer', realName:'無名（EMIYA）', wars:['5th'], gender:'男',
    ...
    dailyLook:'褐膚白髮・面容冷峻的青年、給人可靠又愛操心的兄長感、自稱「我」・嘴上嫌麻煩卻認真叮嚀、私下捨得為別人添麻煩，卻捨不得為自己添件新衣',
  ...
  { id:'庫丘林-Lancer', cls:'Lancer', realName:'庫·丘林', wars:['5th'], gender:'男',
    ...
    dailyLook:'藍髮赤瞳・精壯的青年身影、總是帶著爽朗笑容閒晃在街頭、自稱「俺」・說話豪爽粗獷、私下會把朋友的小事偷偷記在心上',
  ...
  { id:'美杜莎-Rider', cls:'Rider', realName:'美杜莎', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫長髮・高挑、胸前豐盈的矯健女子身影、氣質溫婉恬靜、自稱「我」・寡言低沉卻藏著溫柔、私下看到別人的善意會偷偷紅了眼眶，卻很快眨眼帶過',
  ...
  { id:'美狄亞-Caster', cls:'Caster', realName:'美狄亞', wars:['5th'], gender:'女',
    ...
    dailyLook:'紫色長髮・身形纖細優雅的清麗女子身影、散發優雅疏離的氣息、自稱「我」・溫婉敬語裡帶著小心翼翼、私下對著親手完成的小手作會露出得意笑容',
    dailyOutfit:'溫柔色系的洋裝',
  ...
  { id:'佐佐木小次郎-Assassin', cls:'Assassin', realName:'佐佐木小次郎', wars:['5th'], gender:'男',
    ...
    dailyLook:'紺髮長刀・清瘦的劍客身影、氣質風雅灑脫、自稱「拙者」・慢條斯理偶帶禪意、私下會把路邊撿到的落花收進懷裡，捨不得錯過',
    dailyOutfit:'簡樸和風浴衣',
  ...
  { id:'赫拉克勒斯-Berserker', cls:'Berserker', realName:'赫拉克勒斯', wars:['5th'], gender:'男',
    ...
    dailyLook:'岩肌巨軀・高大健壯的男子身影、像座溫柔的大山總讓人感到安心、話極少・多點頭或簡短回應，偶爾憨厚一笑、私下留意誰的東西提不動，默默出手幫忙',
  ...
  { id:'吉爾伽美什-Archer', cls:'Archer', realName:'吉爾伽美什', wars:['4th'], gender:'男',
    ...
    dailyLook:'金髮赤瞳・俊美的男子身影、即使走在街上也帶著視察領地般的王者餘裕、自稱「吾」・居高臨下卻難掩興致、私下嘴上瞧不上凡俗之物，卻會悄悄記住誰喜歡什麼',
    dailyOutfit:'奢華名牌休閒服',
  ...
  { id:'迪盧木多-Lancer', cls:'Lancer', realName:'迪盧木多·奧迪那', wars:['4th'], gender:'男',
    ...
    dailyLook:'墨綠髮・俊美的騎士身影(面上淡淡的愛之痣)、氣質溫雅內斂、自稱「我」・言談謙恭有禮，情感壓在心底、私下偶爾對著鏡子盯著臉上的痣，猜想惹來多少麻煩',
    dailyOutfit:'整潔的紳士便裝',
  ...
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾（征服王）', wars:['4th'], gender:'男',
    ...
    dailyLook:'紅髮虬髯・魁梧的男子身影、豪邁爽朗中帶著王者的氣度、自稱「余」・豪爽大笑，愛稱人一聲「小鬼」、私下藏著一疊蒐集來的地圖，像個捨不得放手的孩子',
  ...
  { id:'吉爾德萊-Caster', cls:'Caster', realName:'吉爾·德·萊斯', wars:['4th'], gender:'男',
    ...
    dailyLook:'清瘦的貴族身影(無鬚無眉)・總是懷抱著厚重書本、氣質溫文卻帶著一絲神經質的執著、自稱「我」・說話文雅，聊到入迷處會激動、私下聊到那位他敬重的人時，語氣會放軟',
  ...
  { id:'百貌哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（百貌）', wars:['4th'], gender:'男',
    ...
    dailyLook:'戴著骷髏造型面具・裹著深色系裝扮的神秘身影、氣質內斂帶點神祕感、自稱「我們」・低語般說話，偶爾換聲線輪流開口、私下喜歡安靜窩在角落看人來人往',
  ...
  { id:'咒腕之哈桑-Assassin', cls:'Assassin', realName:'哈桑·薩巴赫（咒腕）', wars:['5th'], gender:'男',
    ...
    dailyLook:'戴著骷髏面具・右臂纏著繃帶的沉靜身影、氣質肅穆而低調、自稱「我」・話極少，必要時才低沉簡短開口、面具下的眼神，只在最信任的人面前才透出柔和',
  ...
  { id:'蘭斯洛特-Berserker', cls:'Berserker', realName:'蘭斯洛特（湖之騎士）', wars:['4th'], gender:'男',
    ...
    dailyLook:'黑髮・沉穩的男子身影、氣質略帶一絲憂鬱、話不多・語氣溫和有禮、私下偶爾對著遠方出神，回神後繼續手邊的活',
  ...
  { id:'恩奇都-Lancer', cls:'Lancer', realName:'恩奇都', wars:['客串'], gender:'無',
    ...
    dailyLook:'青綠長髮・中性無垢的身影、氣質平和帶著一絲疏離感、自稱「我」・語氣平和中性卻藏著溫柔、私下惦記著吉爾伽美什，偶爾對著他送的小東西發愣',
  ...
  { id:'斯卡哈-Lancer', cls:'Lancer', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・胸前豐盈、妖豔冷峻的女子身影、氣質居高臨下卻自持有度、自稱「我」・偶爾露出揶揄語氣，帶著嚴師的威嚴、被人稱讚時會怔住，隨即別開臉',
  ...
  { id:'斯卡哈-Assassin', cls:'Assassin', realName:'斯卡哈', wars:['客串'], gender:'女',
    ...
    dailyLook:'紫髮紅瞳・胸前豐盈、冷冽優雅的女子身影、氣質慵懶自在中帶著一絲警覺、自稱「我」・說話低冷簡短・一針見血、私下享受被人依賴，嘴上卻一副事不關己',
  ...
  { id:'美遊-Saber', cls:'Saber', realName:'美遊·埃德費爾特（Saber install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'黑髮・內斂的少女身影、氣質沉靜寡言、自稱「我」・寡言低語，不擅表達卻認真傾聽、對「失敗」很在意，會偷偷練習到深夜',
  ...
  { id:'小黑-Archer', cls:'Archer', realName:'克洛伊·馮·愛因茲貝倫（Archer install）', wars:['客串'], gender:'女',
    ...
    dailyLook:'褐膚白髮・活潑亮眼的少女身影、氣質促狹調皮、自稱「本小姐」・說話促狹挑釁，偶爾會撒嬌耍賴、私下鬥嘴鬥贏了會偷偷開心一整天',
  ...
  { id:'間桐櫻黑化-Master', cls:'御主', realName:'間桐櫻', wars:['客串'], gender:'女',
    ...
    dailyLook:'深紫長髮、身形玲瓏有致的成熟女子身影、氣質沉靜柔順、自稱「我」・語調輕柔卻偶藏小心機、私下會用小惡作劇，悄悄試探對方多在意自己',
  ...
  { id:'藤村大河-Master', cls:'御主', realName:'藤村大河', wars:['客串'], gender:'女',
    ...
    dailyLook:'亞麻色及肩短髮、身形嬌小的身影、雖已是成熟大人卻仍帶著爽朗直率的元氣、自稱「我」・說話中氣十足，得意語氣、私下一看到好吃的東西眼睛就發亮',
