...
var SEED_SERVANTS = [
  ...
  { id:'伊斯坎達爾-Rider', cls:'Rider', realName:'伊斯坎達爾（征服王）', wars:['4th'], gender:'男',
    ...
    align:'中立・善', persona:{firstP:'余',look:'紅髮虬髯・魁梧壯碩的征服王、豪邁爽朗的王者雅量、自稱「余」・豪邁恢弘的王者氣口、把人收進心裡的栽培溫情',words:'豪邁・征服・雅量・王道',toMaster:'視為臣下亦為摯友，要對方先成為夠格的王',speech:'豪爽大笑、稱「小子」、王者氣度、好酒好戰、講大道理',moe:'征服世界的野心與孩子氣並存、愛酒愛地圖、收伏人心的雅量、把御主當孩子般栽培（不分男女）',tic:'仰天大笑、攤開世界地圖、灌下整桶酒'} },
