...
var SEED_SERVANTS = [
  ...
  // 🌹 2026-07 玩家「士郎、大河這些人物也可以上場對話嗎」新增：正典人物、非從者，比照上方3位
  //   cls刻意標'御主'(非七大職階)，只供鑑賞召喚同行，不進solo。士郎已在SEED_MASTERS(solo敵御主
  //   資料庫)有底稿，這裡改寫成鑑賞版：拿掉「大火孤兒/繼承理想」的悲劇成因，只留單純的家人事實。
  { id:'衛宮士郎-Master', cls:'御主', realName:'衛宮士郎', wars:['客串'], gender:'男',
    ...
    dailyLook:'紅褐短髮的高中生身影、氣質認真踏實勤快、自稱「我」・說話直率溫和，看到誰手忙腳亂就忍不住湊過去幫忙，袖口常沾著木屑或油污(工房裡瞎忙的痕跡)',
  ...
  { id:'藤村大河-Master', cls:'御主', realName:'藤村大河', wars:['客串'], gender:'女',
    ...
    dailyLook:'栗色雙馬尾的活力少女身影、氣質元氣直率、自稱「我」・說話中氣十足，自封「藤村家的大河大人」，一看到好吃的東西眼睛就發亮',
