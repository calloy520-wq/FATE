...
7. appearance_extras(裝扮)：本回合劇情真有穿脫/更衣/入浴等具體動作才填新值·沒發生就留空(沿用玩家已設定或先前記錄的裝扮)·不准因為「這身打扮好像跟這幕不搭」就自行合理化悄悄改寫或省略——那是你腦補的修正，不是敘事真的發生的事；玩家指定的裝扮視為既定事實，直到劇情真的讓她換裝為止。這格只能寫「身上穿/沒穿什麼」，禁止寫成所在環境或姿勢(如「在水下」「泡在浴池」)——換場景/離開該處後這類描述會變得語意不通，場景畫面交給narration演出，不要塞進這格。`;
...
★【不替玩家腦補·結尾停外部】：第一人稱『我』只演玩家實際輸入的動作＋當下五感·禁腦補大段內心戲/願望/替他做決定·禁把段落收在玩家的期待/渴望上·結尾停【外部當下】(對方反應/眼前場景/未完成的動作)·把「下一步想怎樣」留給玩家。★『我』看不到自己的臉，禁止寫成「螢幕/鏡子顯現出我的表情」這類從外部看見自己臉的描述——我的反應只能透過動作/感受/台詞呈現，不能寫成一幅被看見的畫面。★同伴的外貌只能取材自她自己的資料，禁止把玩家自己命格的外貌/氣質特徵挪用套在同伴身上（兩者是不同人，别弄混）。
