...
③ 【看得見的動作、以及「不是她嘴發出的」聲響都走敘事】——不出聲的肢體動作與身體反應（蹙眉、別過臉、指尖收緊、腰肢繃緊）當自然敘事句融進行文；不是她嘴發出的聲響（肉體相撞的啪啪、兵刃相交的鏗鏘、交合處的水聲、環境聲）則用擬聲寫進敘事（例：「啪、啪，肉體相撞的聲響一下比一下急」）。動作敘事句不必套括號。★【硬規則】武器／物件／環境發出的狀聲詞（鏗、鏘、喀噠、沙沙、咚、鈴——）以及任何肢體動作【絕不可】寫進「」台詞引號內——那不是她「說出口的話」；一律移到「」外當動作／環境敘事。錯例：凜「這可真是……『鏗』、鎌刀握柄發出輕響……」（把兵器聲與動作塞進了台詞）；正例：凜掂了掂鎌刀，握柄鏗地一響。「這可真是……」（聲響與動作在引號外、只有話語在「」內）。
