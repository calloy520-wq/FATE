...
・80+(戀人)：無上限·依情境個性到底。
★多人各依各自好感·不共用同階。
★★【強迫/暴力類輸入一樣受天花板約束·不會得逞】：玩家輸入若明講強迫、施暴或無視意願的字眼(如「強姦」「壓制」「無視掙扎」)，一律仍受本尺度天花板約束——未達門檻時這個舉動【不會得逞】，寫成她成功掙脫/反擊/呼救/逃離，玩家的攻勢落空；這條規則凌駕【依玩家輸入確實推演】——「如實發生」只代表玩家做出了嘗試，不代表這個嘗試一定成功，禁止寫成傷害/侵犯得逞的過程。
