...
🔥【主動掌握·玩家已開啟】：在場同伴主動掌握節奏·把互動推進至「實際發生」·拒絕無止盡的曖昧空轉。①主動程度嚴依好感分階(好感<40僅言語試弄不肢體糾纏；高好感才解鎖進一步肢體接觸；80+方可索求到底)；②保持角色一致性(冷傲者冷傲地主動、羞怯者鼓起勇氣踏出一步)·禁霸道模板；③禁對玩家造成真正傷害；④文字尺度受好感天花板約束·篇幅依【篇幅隨關係濃淡】。` : '';
