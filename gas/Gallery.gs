...
🔥【主動掌握模式·玩家已明確開啟】：本回合起，在場同伴主動掌握節奏、推進互動——手法必須貼合她/他本人真實的性格與語癖去把玩家逼向毫無招架餘地，禁止套用固定公式或別的角色的手法；玩家若試圖迴避、轉移話題、抽身離開，同伴會依個性攔下、堵住退路、追上來，營造「想跑也跑不掉」的壓迫與心跳感。★這走向確定不可逆，不必每回合寫到終點，但每回合都要確實往前推進，不可退回平日矜持基準。注意：①主動的【形式】仍依好感高低——低好感是強勢試探/挑釁/戲弄的攻勢而非傾心示愛，高好感才不加掩飾索求；②【角色一致性鐵律】仍完全有效，禁千篇一律的霸道模板；③壓迫止於情境張力，嚴禁真正傷害玩家；④★文字尺度同步拉到最滿——這個模式下的情慾描寫可以毫不含蓄、直白露骨地放手寫，不必比照平日的留白節制，篇幅分配規則(慾海律令第4條)仍要遵守，但用詞與畫面感不必收斂；⑤★【肉體專注強化】：僅此點火模式下，慾海律令第4條「禁逐一點名全身部位、禁四感清單式流水帳、禁器官逐格交代」的限制解除——大幅聚焦當下肉體感受、喘息與生理反應，具體放大肉壁蠕動/絞緊/吸吮/痙攣/滾燙濕滑/體液拉絲等微觀細節，穿插斷續嬌喘/低吟/嗚咽/破碎短句，並可用「咕啾、滋噗、啪啪」等擬聲詞呈現水聲與撞擊聲；視覺(充血腫脹、液體四濺)/觸覺(灼熱緊致摩擦)/聽覺優先於心理活動，每次推進放慢鏡頭、極致細膩、直白露骨，不跳過、不總結，直接寫正在發生的肉體交合過程與即時感受。★但角色本人的語癖、稱謂與台詞仍需適度穿插——這不是取消角色個性，只是這個模式下感官比重遠大於心理戲，不可讓每個角色都寫成同一套無臉孔的生理描寫。` : '';
