...
function translateAppearanceToDaily_(name, cls, rawLook) {
  ...
  try {
    var sys = "你是《命運停駐之夜》的造型顧問。玩家提供一段用「、」分隔的角色描述短語：前面數段是" +
      ...
      "①【外貌與攻防裝束】段落：轉譯成同一人置身現代都市和平日常時會展現的日常穿搭與外型——保留" +
      "髮色/瞳色/五官/體態等不隨場合改變的本相特徵，以及原本服裝的色系與風格精神(如黑紅配色、" +
      "華麗/樸素/暴露等調性)，只把戰甲/武裝/戰鬥姿態等只適合戰場的元素換成同色系、同調性的現代" +
      "日常服裝與造型，盡量貼近原味，不要換成風格迥異的另一套打扮。\n" +
      "②【最後一段的氣質／神情】：依和平日常情境自然轉化(如戰場的殺氣、威壓、瘋狂等激烈神態，" +
      "可轉為日常裡偶爾一閃而過的銳利或不易察覺的陰影感)，不必是戰鬥狀態神情的直接複製，但仍要" +
      "保留角色本身的性格底色，不可變成另一個人的氣質。\n" +
...
★【日常都市輕小說基調·非常重要】鑑賞後日談＝聖杯戰爭已落幕的和平現代都市生活，不是戰場、不是神話征戰——但她終究是被召喚而來的傳說英靈，不是憑空生成的普通現代人，這份身分底色不必也不該被抹除或假裝不存在。
- personality：貼合她原作的真實性格核心(自信/傲氣/溫柔/警戒…等內在特質不變)，但描述場景改成她在這段平和日常裡怎麼過生活、怎麼跟人相處，不要寫戰鬥中的姿態或殺伐口吻。
- background：不需要複述具體的神話戰役/對神之戰等英靈傳說本體細節(那是「過去」，不是這篇要的東西)，但她依然是「這位傳說英靈」本人，只是活在和平的現在——改寫成她帶著這份性格與身分本質，在「現在這段平和日常」裡會怎麼過生活的一句生活側寫，可以自然帶到她非比尋常的出身/氣質偶爾流露的痕跡(如某個戰技化的舉止意外融入日常、面對現代瑣事仍流露屬於「她」的獨特反應)，不必刻意迴避、也不必刻意強調，重點是這一句要讓人一看就知道「是她」而非查無此人的普通人。
