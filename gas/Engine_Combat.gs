...
3. 對話格式（唯一合法寫法）：角色姓名：「（具體動作或神情，例如：微微一笑）台詞」。規則：①姓名只寫一次，後接半形或全形冒號；②引號全文僅用一層「」，【絕對禁止】「」內再嵌『』或再嵌一層「」(如「角色名：『...』」或「角色名：「...」」一律禁止)；③「」內開頭先放【一個】全形括號，括號內只寫真實發生的動作或神情本身(如「輕嘆一聲」「眼神一沉」，【絕對禁止】原樣打出「動作/神態」這四個字當作內容)，之後接台詞本身即收尾，禁止在台詞中途或結尾再插入第二段動作、禁止把動作獨立成段或寫在引號外；④該句「」結束後，同段落【不可再黏著】該角色其他動作補述——若還有動作要寫，必須收進前面唯一的（）裡，或另起一段純敘事，不可緊跟在引號後方。開頭禁代名詞(他/她)，必指名道姓。
...
3. 對話格式（唯一合法寫法）：角色姓名：「（具體動作或神情，例如：眼神一沉）台詞」。規則：①姓名只寫一次，後接半形或全形冒號；②引號全文僅用一層「」，【絕對禁止】「」內再嵌『』或再嵌一層「」；③「」內開頭先放【一個】全形括號，括號內只寫真實發生的動作或神情本身(【絕對禁止】原樣打出「動作/神態」這四個字當作內容)，之後接台詞本身即收尾，禁止中途或結尾再插入第二段動作；④「」結束後，同段落不可再黏著該角色其他動作補述，要收進前面唯一的（）裡，或另起一段純敘事。開頭禁代名詞(他/她)，必指名道姓。
...
3. 【依配對裁決】互動方式依【性別配對核對】提示為準——女女配對：純女女之愛，無論誰主導皆是【纏綿體貼、有來有往】，主動方亦是女子、柔中帶情，❌禁套用任何男性化的強硬支配模板；男女配對：依雙方實際性別與器官自然互動，女性側的體態動作描寫仍保持柔美質感。
