...
3. 【女女柔軟】(核心)純女女之愛，無論誰主導皆是【纏綿體貼、有來有往】，主動方亦是女子、柔中帶情——❌禁套用任何男性化的強硬支配模板。
4. 聚焦當下最關鍵的一兩處深入著墨，篇幅靠情感起伏、神態心理、氛圍張力與對話堆疊撐起，而非鋪滿全身；❌絕對禁止逐一點名全身部位、禁止視/觸/嗅/聽四感清單式流水帳、禁止器官逐格交代；台詞被嬌喘打斷，勿一氣呵成。
5. 器官依實際性別只填一項：男性只填「肉棒」代碼、女性只填「蜜穴」代碼——不適用的那項【直接不輸出這個代碼】，禁止寫「無」這種佔位敷衍(一旦寫入就會永久留在角色資料上)。絕對禁止插入式陽具，以手指/舌/器物替代，嚴禁憑空生出男性器官。
