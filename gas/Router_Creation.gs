...
- traits：外貌、氣質舉止、自稱與口氣(第一人稱·如 我/俺/吾＋說話語氣，如 自稱「吾」・睥睨王者腔)、卸下心防的私密一面。${finalSex === '女' ? '外貌段務必包含身形/胸部具體描寫(如巨乳、貧乳、嬌小玲瓏、高挑纖細等，「豐滿」這類籠統形容詞不夠明確，須明講胸部大小)，不要只寫髮色瞳色就交差。' : ''}
...
★【外貌 look】剛好 4 短句頓號分隔，依序為[外貌本相(髮色/瞳色/五官/體態等，不含服裝；若判定此英靈為女性，務必包含身形/胸部具體描寫(如巨乳、貧乳、嬌小玲瓏、高挑纖細等，「豐滿」這類籠統形容詞不夠明確，須明講胸部大小)，不要只寫髮色瞳色就交差)]、[氣質舉止]、[自稱與口氣(固定格式「自稱「X」，再接一句依其說話語氣寫成的口氣描述」)]、[卸下心防的私密一面(具體生活化的小動作，不可直述心情/動機)]。
