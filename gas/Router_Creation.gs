...
★【演出而非說明】personality 與寶具只作底層，靠言行流露。personality 剛好 4 短句頓號分隔、每句限${TRAIT_SEG_HINT_}字內寫完：平常相處看得到的樣子、熟了才看得到的那一面、喜歡的事物、討厭的事物。
