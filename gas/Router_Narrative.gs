...
2. 對話格式（與全遊戲統一）：角色名：「（動作/神態）台詞」。「」內開頭放【一個】全形括號後接台詞即收尾，禁止台詞中途或結尾再插第二段動作、禁止動作獨立成段或寫在引號外；引號全文僅一層「」、禁嵌『』。
...
6b.★【服裝與外貌】角色衣著嚴格依角色卡的「外貌本相／此刻裝扮」描寫，【嚴禁】自行讓任何角色裸露或增減服裝——戰鬥可寫甲冑碎裂衣袂破損、絕不裸身；解除結界/隱匿(如風王結界)只顯現【武器】，與衣著無關。
