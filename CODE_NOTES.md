...
（同日二稿：玩家要「帶點奈須味道但要日常」——魔術／技能／寶具都在、只拿來過日子，偏離日常就用微搞笑拉回；「點到為止」是刻意留的煞車，這條每回合都送、沒煞車就是回頭加料。三稿把例子從「修水管、挑晚餐」換成「會騎乘的人開車厲害、有直感的人聞得出好吃」——玩家「微搞笑不是真無厘頭亂掰，要有點小依據」：用法要從那個人真正的技能／寶具長出來。）
...
- **show-don't-tell 的保護範圍漏了一半**：`perform` 那條「★卡上這些句子只給你看」只描述了
  system 裡的穩定卡（`【在場人物】名字（性別）。…`），而關係稱呼／熟悉度／眼中的你／共同回憶
