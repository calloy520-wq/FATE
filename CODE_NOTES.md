...
### `kanshouBondFloorOf_`　<sub>Gallery.gs</sub>
...
### `kanshouSyncRelTier_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_CUSTOM_TAG_BOND_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_CONFESS_BOND_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_RAPPORT_BOND_TIERS_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_RAPPORT_TONE_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_SCENE_BOND_`　<sub>Gallery.gs</sub>
...
### `kanshouRelChatCeiling_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_LOCATION_TAGS_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_ASLEEP_HOUR_END_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_LOCATION_EVENTS_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_GENERIC_HOME_POOL_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_NIGHT_PART_TAG_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_INIT_BASE_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_INIT_VISIT_FROM_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_FIRSTS_TAG_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_REL_RANK_TAG_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_CHILL_DAY_TAG_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_MISS_COPY_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_REL_TIER_`　<sub>Gallery.gs</sub>

門檻借用鑑賞既有的兩個好感節點(60=夜襲橋段門檻、80=同床共枕門檻)當切點，數字只有一處來源。

### `_reachedWas`　<sub>Gallery.gs</sub>
...
### `kanshouRapportTone_`　<sub>Gallery.gs</sub>
...
### `KANSHOU_BOND_FLOOR_TAG_`　<sub>Gallery.gs</sub>

0＝還沒跨過任何門檻。只升不降，是刻意的——那正是「鎖住」這件事本身。

### `KANSHOU_CHILL_MIN_DROP_`　<sub>Gallery.gs</sub>

爽約(-5)與 AI 明確表達不滿(-3 以上)才是真的有事發生。

### `kanshouRelTierLabel_`　<sub>Gallery.gs</sub>
...
### `moveTarget0_`　<sub>Gallery.gs</sub>
...
### `kanshouProposalResult_`　<sub>Gallery.gs</sub>
...
### `relChangesToProcess`　<sub>Gallery.gs</sub>
