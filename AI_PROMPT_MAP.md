...
> ★這個世界＝和平的現代日常，大家都是普通市民，任何動漫元素也只會用在日常生活（玩家 2026-09-23 定稿）／★【性別】：在場每個人的性別以卡上寫的為準（取代舊的女×女 ★【身體】說明）
> `${PROMPT_REL}`（🛑【角色一致性】等）
...
> ★【此刻】（「季節的時段」兩個詞**只在時段換了才送**，講過的存【此刻已述】；節奏那句每回合都在。2026-09-23：數字會被整串念進敘事，改成字之後五步有四步拿「冬天的清晨」當開頭，於是講過就不再送）＋★【今晚留下的人】／★【晨間餘韻·非強制】（都依「這回合她在不在場」過濾）
