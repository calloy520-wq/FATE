...
//   basic ＝ 全普攻，opts={}(不含施放技術加成、不解放寶具)——比六圍+常駐被動(fx)的裸體力。
//            ⚠ 真實遊戲已無「關閉」這個開關(施放技術被動化·2026-07)：每次交鋒 50% 機率自動全效發動，
//            沒有「關閉時仍吃微量版」這回事——這裡的 basic 純屬合成基準線(0% 發動)，不對應任何真實可選狀態，
//            用來看「拔掉施放技術」對排名的影響有多大，跟 skill(100% 全效)兩端夾出實戰期望值(≈中點)。
//   skill ＝ 開啟施放技術(servantActiveSkill_ 全效，若無真·施放技術則跟 basic 相同)，仍不解放寶具。
