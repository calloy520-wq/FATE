...
| 形狀 | 舊 | 新 |
|---|---|---|
| **確認框寫成說明書**（條列後果＋括號補充） | 💧 補魔：御主硬擠魔術迴路，將共用魔力池一口氣回滿。⚠ 代價【永久】：…（迴路↓會讓魔力池上限縮小、回魔變慢、禮裝變弱）。這是燒迴路換契約的孤注一擲…（想省代價：靠靈脈/陣地/休息自然回魔。注意：池見底會被動燃血、缺口÷2 由御主血量獨自承擔。）確定補魔？ | 💧 補魔：硬擠迴路，把魔力池灌回滿。代價是永久的：血上限 −N、魔術迴路 −M 條。用多了會慢性自盡。補嗎？ |
...
| **文言腔的錯誤訊息** | 御主的魔力儲備已然充盈，毋須補魔（免付燒蝕之代價）。／輿圖之上查無此地，無路可達。／行動點用完了，從者也需要喘口氣。先歇息，恢復了再戰。 | 魔力是滿的，不用補。／地圖上沒有這個地方。／行動力用完了，先休息。 |

幾個決定：
- **數字只留在玩家要據此做決定的地方**（補魔的永久代價、令咒還剩幾道、海怪每小時抽幾魔、破戒的 35%）。
  說明性的公式（「2 點血換 1 點魔，血剩 1 就停」「缺口÷2」）全拿掉——那是規則書，不是按鈕。
- **「行動力不夠，沒辦法XX。先休息，恢復了再來。」十幾處統一成「行動力不夠，先休息。」**
